...
function stopclock() {
	timerRunning && clearTimeout(timerID), timerRunning = !1
}
...
function onload_leftTime(e) {
	try {
		_GMTEndTime = gmt_end_time, _day = day, _hour = hour, _minute = minute, _second = second, _end = end
	} catch(t) {}
	if(_GMTEndTime > 0) {
...
function addToCart(e, t) {
	...
	document.getElementsByName("store_id").length > 0 && (r = document.getElementsByName("store_id")[0].value), i.quick = o, i.spec = n, i.goods_id = e, i.store_id = parseInt(r), i.number = s, i.parent = "undefined" == typeof t ? 0 : parseInt(t), $.post("index.php?r=cart/index/add_to_cart", {
		goods: $.toJSON(i)
	}, function(e) {
		addToCartResponse(e)
	}, "json")
...
function formatNumber(e, t) {
	...
	if(i = e.toString(), n = i.indexOf("."), s = i.length, 0 == t) n != -1 && (i = i.substring(0, n));
		...
		for(i = i.substring(0, n + t + 1), a = s; a <= n + t; a++) i += "0";
	return i
}
...
function getCoordinate(e) {
	...
	t.x = document.body.offsetLeft, t.y = document.body.offsetTop;
	do t.x += e.offsetLeft, t.y += e.offsetTop, e = e.offsetParent; while ("BODY" != e.tagName.toUpperCase());
	return t
}
...
function display_mode(e) {
	...
	document.getElementById("display").value = e, setTimeout(t, 0)
}

function display_mode_wholesale(e) {
	function t() {
		document.forms.wholesale_goods.action = "index.php?c=wholesale&a=index", document.forms.wholesale_goods.submit()
	}
	document.getElementById("display").value = e, setTimeout(t, 0)
}
...
function fixpng() {
	var e = navigator.appVersion.split("MSIE"),
		t = parseFloat(e[1]);
	if(t >= 5.5 && document.body.filters)
...
function hash(e, t) {
	...
	for(; i < e.length;) s = stringxor(s, e.substr(i, t)), i += t;
	return s
}
...
function appendscript(e, t, i, n) {
	...
	if(i || !in_array(s, evalscripts)) {
		i && $$(s) && $$(s).parentNode.removeChild($$(s)), evalscripts.push(s);
		var a = document.createElement("script");
		a.type = "text/javascript", a.id = s;
		try {
			e ? a.src = e : t && (a.text = t), $$("append_parent").appendChild(a)
		} catch(o) {}
	}
}
...
function pmwindrag(e, t) {
	if(1 == t) pmwindragstart = is_ie ? [event.clientX, event.clientY] : [e.clientX, e.clientY], pmwindragstart[2] = parseInt($$("pmlayer").style.left), pmwindragstart[3] = parseInt($$("pmlayer").style.top), doane(e);
	else if(2 == t && pmwindragstart[0]) {
		var i = is_ie ? [event.clientX, event.clientY] : [e.clientX, e.clientY];
		$$("pmlayer").style.left = pmwindragstart[2] + i[0] - pmwindragstart[0] + "px", $$("pmlayer").style.top = pmwindragstart[3] + i[1] - pmwindragstart[1] + "px", doane(e)
	} else 3 == t && (pmwindragstart = [], doane(e))
}

function doane(t) {
	e = t ? t : window.event, is_ie ? (e.returnValue = !1, e.cancelBubble = !0) : e && (e.stopPropagation(), e.preventDefault())
}
...
function openSpeDiv(e, t, i) {
	var n = "speDiv",
		s = "mask";
	docEle(n) && document.removeChild(docEle(n)), docEle(s) && document.removeChild(docEle(s));
	var a;
	...
	l.id = n, l.style.position = "absolute", l.style.zIndex = "10000", l.style.width = "300px", l.style.height = "260px", l.style.top = parseInt(a + 200) + "px", l.style.left = (parseInt(document.body.offsetWidth) - 200) / 2 + "px", l.style.overflow = "auto", l.style.background = "#FFF", l.style.border = "3px solid #59B0FF", l.style.padding = "5px", l.innerHTML = '<h4 style="font-size:14; margin:15 0 0 15;">' + select_spe + "</h4>";
	for(var c = 0; c < e.length; c++)
		if(l.innerHTML += '<hr style="color: #EBEBED; height:1px;"><h6 style="text-align:left; background:#ffffff; margin-left:15px;">' + e[c].name + "</h6>", 1 == e[c].attr_type) {
	...
	l.innerHTML += "<br /><center>[<a href='javascript:submit_div(" + t + "," + i + ")' class='f6' >" + btn_buy + "</a>]&nbsp;&nbsp;[<a href='javascript:cancel_div()' class='f6' >" + is_cancel + "</a>]</center>", document.body.appendChild(l);
	var h = document.createElement("div");
	h.id = s, h.style.position = "absolute", h.style.zIndex = "9999", h.style.width = document.body.scrollWidth + "px", h.style.height = document.body.scrollHeight + "px", h.style.top = "0px", h.style.left = "0px", h.style.background = "#FFF", h.style.filter = "alpha(opacity=30)", h.style.opacity = "0.40", document.body.appendChild(h)
}
...
function submit_div(e, t) {
	...
	i.quick = o, i.spec = n, i.goods_id = e, i.number = s, i.parent = "undefined" == typeof t ? 0 : parseInt(t), $.post("index.php?c=flow&a=add_to_cart", {
		goods: $.toJSON(i)
	}, function(e) {
		addToCartResponse(e)
	}, "json"), document.body.removeChild(docEle("speDiv")), document.body.removeChild(docEle("mask"));
	for(var c = 0, d = document.getElementsByTagName("select"); d[c];) d[c].style.visibility = "", c++
}

function cancel_div() {
	document.body.removeChild(docEle("speDiv")), document.body.removeChild(docEle("mask"));
	for(var e = 0, t = document.getElementsByTagName("select"); t[e];) t[e].style.visibility = "", e++
}
...
function addToCartResponse_quick(e) {
	...
	else if(e.store_id > 0 && (window.location.href = "index.php?r=flow&store_id=" + e.store_id + "&cart_value=" + e.cart_value), d_messages("商品已加入购物", 2), $(".cart-num").html(e.goods_number), $(".j-filter-show-div").hasClass("show")) return $(".j-filter-show-div").removeClass("show"), $(".mask-filter-div").removeClass("show"), !1
}
...
function in_addToCart(e, t) {
	var i = new Object,
		...
		a = 0;
	e || (e = $(".goods-id").val()), ($(".goods-size").hasClass() || $(".goods-color").hasClass()) && (a = 1), i.quick = a, i.spec = n, i.goods_id = e, i.number = s, i.parent = "undefined" == typeof t ? 0 : parseInt(t), $.ajax({
		...
		dataType: "json",
		success: function(e) {
			0 == e.error ? d_messages("已加入购物车", 2) : d_messages(e.message, 2), window.location.reload()
		}
	})
}
...
function addtocart_attr(e) {
	...
	$("label.ts-1" + e).each(function() {
	...
	}), t.goods_id = e, t.spec = str.substr(0, str.length - 1).split(","), t.number = $(".attr-number" + e).val(), t.warehouse_id = $("input[name=warehouse_id]").val(), t.area_id = $("input[name=area_id]").val(), t.quick = i, $.ajax({
		url: "index.php?r=cart/index/add_to_cart",
		type: "POST",
		data: {
			goods: $.toJSON(t)
		...
		dataType: "json",
		success: function(e) {
			0 == e.error ? d_messages("已加入购物车", 2) : d_messages(e.message, 2), window.location = "index.php?r=cart/index"
		}
	})
}
...
function addtocart_list(e) {
	...
	}), t.goods_id = e, t.spec = strr.substr(0, strr.length - 1).split(","), t.number = $("input[name=number" + e + "]").val(), t.warehouse_id = $("input[name=warehouse_id]").val(), t.area_id = $("input[name=area_id]").val(), t.quick = i, $.ajax({
		url: "index.php?r=cart/index/add_to_cart",
		type: "POST",
		data: {
			goods: $.toJSON(t)
...
function receivebonus(id) {
	$.ajax({
		...
		success: function(data) {
			data = eval("(" + data + ")"), data.code ? layer.open({
				content: "请登录后领取",
				btn: ["立即登录", "取消"],
				shadeClose: !1,
				yes: function() {
...
function d_messages(e, t) {
	var i = "";
	t = arguments[1] ? arguments[1] : 2, 1 == t && (i = "border:none; background: rgba(0,0,0,.7); color:#fff; max-width:100%; top:0; position:fixed; left:0; right:0; border-radius:0;"), 2 == t && (i = "border:none; background: rgba(0,0,0,.7); color:#fff; max-width:90%; min-width:1rem; margin:0 auto; border-radius:.8rem;"), layer.open({
		style: i,
		type: 0,
		anim: 3,
		content: e,
...
function showregionname() {
	...
	function c(e) {
		var t;
		for(t in e)
			if(("data" !== t || !se.isEmptyObject(e[t])) && "toJSON" !== t) return !1;
		return !0
	}
	...
	function d(e, t, i, n) {
		if(se.acceptData(e)) {
			var s, a, o = se.expando,
				...
				l = r ? se.cache : e,
				c = r ? e[o] : e[o] && o;
			if(c && l[c] && (n || l[c].data) || void 0 !== i || "string" != typeof t) return c || (c = r ? e[o] = G.pop() || se.guid++ : o), l[c] || (l[c] = r ? {} : {
				toJSON: se.noop
			}), ("object" == typeof t || "function" == typeof t) && (n ? l[c] = se.extend(l[c], t) : l[c].data = se.extend(l[c].data, t)), a = l[c], n || (a.data || (a.data = {}), a = a.data), void 0 !== i && (a[se.camelCase(t)] = i), "string" == typeof t ? (s = a[t], null == s && (s = a[se.camelCase(t)])) : s = a, s
		}
	}
		...
		if(se.acceptData(e)) {
			...
			if(o[r]) {
				if(t && (n = i ? o[r] : o[r].data)) {
					se.isArray(t) ? t = t.concat(se.map(t, se.camelCase)) : t in n ? t = [t] : (t = se.camelCase(t), t = t in n ? [t] : t.split(" ")), s = t.length;
					for(; s--;) delete n[t[s]];
	...
	function g(e, t) {
		...
		if(!a)
			for(a = [], i = e.childNodes || e; null != (n = i[s]); s++) !t || se.nodeName(n, t) ? a.push(n) : se.merge(a, g(n, t));
	...
	function x(e, t) {
		if(1 === t.nodeType && se.hasData(e)) {
			...
			if(r) {
				...
				for(i in r)
					for(n = 0, s = r[i].length; s > n; n++) se.event.add(t, i, r[i][n])
			}
	...
	function T(e) {
		var t = fe,
			i = Ze[e];
		return i || (i = k(e, t), "none" !== i && i || (Je = (Je || se("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Je[0].contentWindow || Je[0].contentDocument).document, t.write(), t.close(), i = k(e, t), Je.detach()), Ze[e] = i), i
	}
	...
	function D(e, t) {
		if(t in e) return t;
		for(var i = t.charAt(0).toUpperCase() + t.slice(1), n = t, s = ut.length; s--;)
			if(t = ut[s] + i, t in e) return t;
		return n
	}

	function E(e, t) {
		for(var i, n, s, a = [], o = 0, r = e.length; r > o; o++) n = e[o], n.style && (a[o] = se._data(n, "olddisplay"), i = n.style.display, t ? (a[o] || "none" !== i || (n.style.display = ""), "" === n.style.display && Ee(n) && (a[o] = se._data(n, "olddisplay", T(n.nodeName)))) : (s = Ee(n), (i && "none" !== i || !s) && se._data(n, "olddisplay", s ? i : se.css(n, "display"))));
		for(o = 0; r > o; o++) n = e[o], n.style && (t && "none" !== n.style.display && "" !== n.style.display || (n.style.display = t ? a[o] || "" : "none"));
		return e
	}
	...
	function P(e, t, i, n, s) {
		for(var a = i === (n ? "border" : "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > a; a += 2) "margin" === i && (o += se.css(e, i + De[a], !0, s)), n ? ("content" === i && (o -= se.css(e, "padding" + De[a], !0, s)), "margin" !== i && (o -= se.css(e, "border" + De[a] + "Width", !0, s))) : (o += se.css(e, "padding" + De[a], !0, s), "padding" !== i && (o += se.css(e, "border" + De[a] + "Width", !0, s)));
		return o
	}
	...
	function M(e, t, i) {
		...
		if(0 >= s || null == s) {
			...
			n = o && (ie.boxSizingReliable() || s === e.style[t]), s = parseFloat(s) || 0
		}
	...
	function A(e, t) {
		var i, n = {
			...
			s = 0;
		for(t = t ? 1 : 0; 4 > s; s += 2 - t) i = De[s], n["margin" + i] = n["padding" + i] = e;
		return t && (n.opacity = n.width = e), n
	}

	function O(e, t, i) {
		for(var n, s = (bt[t] || []).concat(bt["*"]), a = 0, o = s.length; o > a; a++)
	...
	function z(e, t, i) {
		...
		})), 1 === e.nodeType && ("height" in t || "width" in t) && (i.overflow = [p.overflow, p.overflowX, p.overflowY], c = se.css(e, "display"), d = "none" === c ? se._data(e, "olddisplay") || T(e.nodeName) : c, "inline" === d && "none" === se.css(e, "float") && (ie.inlineBlockNeedsLayout && "inline" !== T(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")), i.overflow && (p.overflow = "hidden", ie.shrinkWrapBlocks() || h.always(function() {
		...
		if(se.isEmptyObject(u)) "inline" === ("none" === c ? T(e.nodeName) : c) && (p.display = c);
			...
			m ? "hidden" in m && (f = m.hidden) : m = se._data(e, "fxshow", {}), a && (m.hidden = !f), f ? se(e).show() : h.done(function() {
				se(e).hide()
			}), h.done(function() {
				var t;
			...
			for(n in u) o = O(f ? m[n] : 0, n, h), n in m || (m[n] = o.start, f && (o.end = o.start, o.start = "width" === n || "height" === n ? 1 : 0))
		}
	}
	...
	function $(e, t) {
		var i, n, s, a, o;
		for(i in e)
			if(n = se.camelCase(i), s = t[n], a = e[i], se.isArray(a) && (s = a[1], a = e[i] = a[0]), i !== n && (e[n] = a, delete e[i]), o = se.cssHooks[n], o && "expand" in o) {
	...
	function H(e, t, i) {
		var n, s, a = 0,
			...
			d = c.props;
		for($(d, c.opts.specialEasing); o > a; a++)
			if(n = yt[a].call(c, e, d, c.opts)) return n;
		return se.map(d, O, c), se.isFunction(c.opts.start) && c.opts.start.call(e, c), se.fx.timer(se.extend(l, {
			elem: e,
			anim: c,
			queue: c.opts.queue
	...
	function L(e) {
		return function(t, i) {
			...
			if(se.isFunction(i))
				for(; n = a[s++];) "+" === n.charAt(0) ? (n = n.slice(1) || "*", (e[n] = e[n] || []).unshift(i)) : (e[n] = e[n] || []).push(i)
		}
	}
	...
	function W(e, t, i, n) {
		function s(r) {
			var l;
			return a[r] = !0, se.each(e[r] || [], function(e, r) {
				var c = r(t, i, n);
	...
	se.fn = se.prototype = {
		...
		var e, t, i, n, s, a, o = arguments[0] || {},
			...
			l = arguments.length,
			c = !1;
		for("boolean" == typeof o && (c = o, o = arguments[r] || {}, r++), "object" == typeof o || se.isFunction(o) || (o = {}), r === l && (o = this, r--); l > r; r++)
			if(null != (s = arguments[r]))
				for(n in s) e = o[n], i = s[n], o !== i && (c && i && (se.isPlainObject(i) || (t = se.isArray(i))) ? (t ? (t = !1, a = e && se.isArray(e) ? e : []) : a = e && se.isPlainObject(e) ? e : {}, o[n] = se.extend(c, a, i)) : void 0 !== i && (o[n] = i));
		return o
	}, se.extend({
		...
		each: function(e, t, n) {
			...
			if(n) {
				...
				for(a in e)
					if(s = t.call(e[a], a, e[a]), s === !1) break;
			return e
		},
		trim: function(e) {
		...
		makeArray: function(e, t) {
			var n = t || [];
			return null != e && (i(Object(e)) ? se.merge(n, "string" == typeof e ? [e] : e) : Q.call(n, e)), n
		},
		...
		grep: function(e, t, i) {
			for(var n, s = [], a = 0, o = e.length, r = !i; o > a; a++) n = !t(e[a], a), n !== r && s.push(e[a]);
			return s
		},
		map: function(e, t, n) {
			var s, a = 0,
				...
				l = [];
			if(r)
				for(; o > a; a++) s = t(e[a], a, n), null != s && l.push(s);
			else
				for(a in e) s = t(e[a], a, n), null != s && l.push(s);
			return K.apply([], l)
		},
		guid: 1,
		proxy: function(e, t) {
			var i, n, s;
			return "string" == typeof t && (s = e[t], t = e, e = s), se.isFunction(e) ? (i = X.call(arguments, 2), n = function() {
	...
	var ce = function(e) {
			...
			if(A && !n) {
				if(s = ye.exec(e))
					if(o = s[1]) {
						...
						} else if(t.ownerDocument && (a = t.ownerDocument.getElementById(o)) && H(t, a) && a.id === o) return i.push(a), i
					} else {
						if(s[2]) return Z.apply(i, t.getElementsByTagName(e)), i;
						if((o = s[3]) && _.getElementsByClassName && t.getElementsByClassName) return Z.apply(i, t.getElementsByClassName(o)), i
					}
				if(_.qsa && (!O || !O.test(e))) {
					if(p = h = L, f = t, m = 9 === r && e, 1 === r && "object" !== t.nodeName.toLowerCase()) {
						...
						f = be.test(e) && d(t.parentNode) || t, m = c.join(",")
					}
					if(m) try {
		...
		function v(e, t, i, s, a, o) {
			return s && !s[L] && (s = v(s)), a && !a[L] && (a = v(a, o)), n(function(n, o, r, l) {
				var c, d, h, u = [],
					p = [],
					f = o.length,
					...
					b = i ? a || (n ? e : f || s) ? [] : o : y;
				if(i && i(y, b, r, l), s)
					for(c = g(b, p), s(c, [], r, l), d = c.length; d--;)(h = c[d]) && (b[p[d]] = !(y[p[d]] = h));
				if(n) {
					if(a || e) {
						if(a) {
				...
				} else b = g(b === o ? b.splice(f, b.length) : b), a ? a(null, o, b, l) : Z.apply(o, b)
			})
		}
		...
		function y(e) {
			for(var t, i, n, s = e.length, a = x.relative[e[0].type], o = a || x.relative[" "], r = a ? 1 : 0, l = p(function(e) {
				...
				if(i = x.relative[e[r].type]) d = [p(f(d), i)];
				else {
		...
		try {
			Z.apply(K = ee.call(W.childNodes), W.childNodes), K[W.childNodes.length].nodeType
		} catch(Ce) {
			Z = {
		...
		_ = t.support = {}, k = t.isXML = function(e) {
			...
			return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, N = i.documentElement, A = !k(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() {
				...
				e.innerHTML = "<select msallowclip=''><option selected=''></option></select>", e.querySelectorAll("[msallowclip^='']").length && O.push("[*^$]=" + ne + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || O.push("\\[" + ne + "*(?:value|" + ie + ")"), e.querySelectorAll(":checked").length || O.push(":checked")
			}), s(function(e) {
				...
				_.disconnectedMatch = $.call(e, "div"), $.call(e, "[s!='']:x"), z.push("!=", re)
			}), O = O.length && new RegExp(O.join("|")), z = z.length && new RegExp(z.join("|")), t = ve.test(N.compareDocumentPosition), H = t || ve.test(N.contains) ? function(e, t) {
			...
			return(e.ownerDocument || e) !== j && M(e), H(e, t)
		}, t.attr = function(e, t) {
			...
			filter: {
					...
					return 1 === n && 0 === s ? function(e) {
						...
						if(g) {
							...
							if(f = [o ? g.firstChild : g.lastChild], o && y) {
								for(d = g[L] || (g[L] = {}), c = d[e] || [], p = c[0] === R && c[1], u = c[0] === R && c[2], h = p && g.childNodes[p]; h = ++p && h && h[m] || (u = p = 0) || f.pop();)
				...
				PSEUDO: function(e, i) {
					...
					return a[L] ? a(i) : a.length > 1 ? (s = [e, e, "", i], x.setFilters.hasOwnProperty(e.toLowerCase()) ? n(function(e, t) {
						for(var n, s = a(e, i), o = s.length; o--;) n = te.call(e, s[o]), e[n] = !(t[n] = s[o])
					}) : function(e) {
						return a(e, 0, s)
					}) : a
				}
			...
			pseudos: {
				not: n(function(e) {
					...
					return s[L] ? n(function(e, t, i, n) {
						...
						return t[0] = e, s(t, null, a, i), !i.pop()
					}
				}),
				has: n(function(e) {
					return function(i) {
				...
				lang: n(function(e) {
					return pe.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(_e, xe).toLowerCase(),
						function(t) {
							var i;
							do
								if(i = A ? t.lang : t.getAttribute("xml:lang") || t.getAttribute("lang")) return i = i.toLowerCase(), i === e || 0 === i.indexOf(e + "-"); while ((t = t.parentNode) && 1 === t.nodeType);
							return !1
						}
				}),
				target: function(t) {
		...
		return h.prototype = x.filters = x.pseudos, x.setFilters = new h, T = t.tokenize = function(e, i) {
			var n, s, a, o, r, l, c, d = q[e + " "];
			if(d) return i ? 0 : d.slice(0);
			for(r = e, l = [], c = x.preFilter; r;) {
				(!n || (s = ce.exec(r))) && (s && (r = r.slice(s[0].length) || r), l.push(a = [])), n = !1, (s = de.exec(r)) && (n = s.shift(), a.push({
					value: n,
					type: s[0].replace(le, " ")
				}), r = r.slice(n.length));
			...
			var i, n = [],
				...
				a = V[e + " "];
			if(!a) {
				for(t || (t = T(e)), i = t.length; i--;) a = y(t[i]), a[L] ? n.push(a) : s.push(a);
				a = V(e, b(s, n)), a.selector = e
			}
			return a
			...
			if(i = i || [], 1 === h.length) {
				...
				for(s = fe.needsContext.test(e) ? 0 : a.length; s-- && (o = a[s], !x.relative[r = o.type]);)
					if((l = x.find[r]) && (n = l(o.matches[0].replace(_e, xe), be.test(a[0].type) && d(t.parentNode) || t))) {
						if(a.splice(s, 1), e = n.length && u(a), !e) return Z.apply(i, n), i;
						break
					}
			}
			return(c || S(e, h))(n, t, !A, i, be.test(e) && d(t.parentNode) || t), i
		}, _.sortStable = L.split("").sort(Y).join("") === L, _.detectDuplicates = !!P, M(), _.sortDetached = s(function(e) {
	...
	se.filter = function(e, t, i) {
		...
		find: function(e) {
			...
			return i = this.pushStack(s > 1 ? se.unique(i) : i), i.selector = this.selector ? this.selector + " " + e : e, i
		},
		filter: function(e) {
	...
	var pe, fe = e.document,
		...
		ge = se.fn.init = function(e, t) {
			...
			if("string" == typeof e) {
				...
				if(i[1]) {
					if(t = t instanceof se ? t[0] : t, se.merge(this, se.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : fe, !0)), he.test(i[1]) && se.isPlainObject(t))
	...
	se.extend({
		dir: function(e, t, i) {
			for(var n = [], s = e[t]; s && 9 !== s.nodeType && (void 0 === i || 1 !== s.nodeType || !se(s).is(i));) 1 === s.nodeType && n.push(s), s = s[t];
			return n
		},
		...
		closest: function(e, t) {
			for(var i, n = 0, s = this.length, a = [], o = de.test(e) || "string" != typeof e ? se(e, t || this.context) : 0; s > n; n++)
				for(i = this[n]; i && i !== t; i = i.parentNode)
					if(i.nodeType < 11 && (o ? o.index(i) > -1 : 1 === i.nodeType && se.find.matchesSelector(i, e))) {
						a.push(i);
						break
					}
		...
		se.fn[e] = function(i, n) {
			...
			return "Until" !== e.slice(-5) && (n = i), n && "string" == typeof n && (s = se.filter(n, s)), this.length > 1 && (ye[e] || (s = se.unique(s)), ve.test(e) && (s = s.reverse())), this.pushStack(s)
		}
	});
	var be = /\S+/g,
		we = {};
	se.Callbacks = function(e) {
		...
		var t, i, n, s, o, r, l = [],
			c = !e.once && [],
			d = function(a) {
				for(i = e.memory && a, n = !0, o = r || 0, r = 0, s = l.length, t = !0; l && s > o; o++)
					if(l[o].apply(a[0], a[1]) === !1 && e.stopOnFalse) {
						i = !1;
						break
					}
				t = !1, l && (c ? c.length && d(c.shift()) : i ? l = [] : h.disable())
			},
			h = {
				add: function() {
					if(l) {
						...
						}(arguments), t ? s = l.length : i && (r = n, d(i))
					}
					return this
				},
				remove: function() {
					return l && se.each(arguments, function(e, i) {
						for(var n;
							(n = se.inArray(i, l, n)) > -1;) l.splice(n, 1), t && (s >= n && s--, o >= n && o--)
					}), this
				},
				has: function(e) {
		...
		Deferred: function(e) {
			var t = [
				...
				s = {};
			return n.pipe = n.then, se.each(t, function(e, a) {
				var o = a[2],
					r = a[3];
		...
		when: function(e) {
			...
			if(o > 1)
				for(t = new Array(o), i = new Array(o), n = new Array(o); o > s; s++) a[s] && se.isFunction(a[s].promise) ? a[s].promise().done(c(s, n, a)).fail(l.reject).progress(c(s, i, t)) : --r;
	...
	se.fn.ready = function(e) {
		...
		ready: function(e) {
			if(e === !0 ? !--se.readyWait : !se.isReady) {
				...
				se.isReady = !0, e !== !0 && --se.readyWait > 0 || (_e.resolveWith(fe, [se]), se.fn.triggerHandler && (se(fe).triggerHandler("ready"), se(fe).off("ready")))
			}
		}
	}), se.ready.promise = function(t) {
		if(!_e)
			if(_e = se.Deferred(), "complete" === fe.readyState) setTimeout(se.ready);
	...
	se.extend({
		...
		hasData: function(e) {
			return e = e.nodeType ? se.cache[e[se.expando]] : e[se.expando], !!e && !c(e)
		},
		data: function(e, t, i) {
			return d(e, t, i)
		},
		...
		promise: function(e, t) {
			...
			for("string" != typeof e && (t = e, e = void 0), e = e || "fx"; o--;) i = se._data(a[o], e + "queueHooks"), i && i.empty && (n++, i.empty.add(r));
	...
	var Se = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
		...
		Ie = se.access = function(e, t, i, n, s, a, o) {
			...
			if("object" === se.type(i)) {
				...
				for(; l > r; r++) t(e[r], i, o ? n : n.call(e[r], r, t(e[r], i)));
	...
	se.event = {
		...
		add: function(e, t, i, n, s) {
			...
			if(g) {
				for(i.handler && (l = i, i = l.handler, s = l.selector), i.guid || (i.guid = se.guid++), (o = g.events) || (o = g.events = {}), (d = g.handle) || (d = g.handle = function(e) {
					...
					}, d.elem = e), t = (t || "").match(be) || [""], r = t.length; r--;) a = Oe.exec(t[r]) || [], p = m = a[1], f = (a[2] || "").split(".").sort(), p && (c = se.event.special[p] || {}, p = (s ? c.delegateType : c.bindType) || p, c = se.event.special[p] || {}, h = se.extend({
					type: p,
					origType: m,
					data: n,
					handler: i,
			...
			if(g && (d = g.events)) {
				for(t = (t || "").match(be) || [""], c = t.length; c--;)
					if(r = Oe.exec(t[c]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p) {
						for(h = se.event.special[p] || {}, p = (n ? h.delegateType : h.bindType) || p, u = d[p] || [], r = r[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = a = u.length; a--;) o = u[a], !s && m !== o.origType || i && i.guid !== o.guid || r && !r.test(o.namespace) || n && n !== o.selector && ("**" !== n || !o.selector) || (u.splice(a, 1), o.selector && u.delegateCount--, h.remove && h.remove.call(e, o));
						l && !u.length && (h.teardown && h.teardown.call(e, f, g.handle) !== !1 || se.removeEvent(e, p, g.handle), delete d[p])
					} else
						for(p in d) se.event.remove(e, p + t[c], i, n, !0);
		...
		trigger: function(t, i, n, s) {
			...
			if(r = d = n = n || fe, 3 !== n.nodeType && 8 !== n.nodeType && !Ae.test(p + se.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), o = p.indexOf(":") < 0 && "on" + p, t = t[se.expando] ? t : new se.Event(p, "object" == typeof t && t), t.isTrigger = s ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), i = null == i ? [t] : se.makeArray(i, [t]), c = se.event.special[p] || {}, s || !c.trigger || c.trigger.apply(n, i) !== !1)) {
				if(!s && !c.noBubble && !se.isWindow(n)) {
					for(l = c.delegateType || p, Ae.test(l + p) || (r = r.parentNode); r; r = r.parentNode) u.push(r), d = r;
					d === (n.ownerDocument || fe) && u.push(d.defaultView || d.parentWindow || e)
				}
				for(h = 0;
					(r = u[h++]) && !t.isPropagationStopped();) t.type = h > 1 ? l : c.bindType || p, a = (se._data(r, "events") || {})[t.type] && se._data(r, "handle"), a && a.apply(r, i), a = o && r[o], a && a.apply && se.acceptData(r) && (t.result = a.apply(r, i), t.result === !1 && t.preventDefault());
				if(t.type = p, !s && !t.isDefaultPrevented() && (!c._default || c._default.apply(u.pop(), i) === !1) && se.acceptData(n) && o && n[p] && !se.isWindow(n)) {
					d = n[o], d && (n[o] = null), se.event.triggered = p;
					try {
						n[p]()
					} catch(m) {}
					se.event.triggered = void 0, d && (n[o] = d)
				}
				return t.result
			}
		},
			...
			if(r && l.nodeType && (!e.button || "click" !== e.type))
				for(; l != this; l = l.parentNode || this)
					if(1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
						for(s = [], a = 0; r > a; a++) n = t[a], i = n.selector + " ", void 0 === s[i] && (s[i] = n.needsContext ? se(i, this).index(l) >= 0 : se.find(i, this, null, [l]).length), s[i] && s.push(n);
						s.length && o.push({
							elem: l,
							handlers: s
						})
		...
		fix: function(e) {
			...
			var t, i, n, s = e.type,
				a = e,
				o = this.fixHooks[s];
			for(o || (this.fixHooks[s] = o = Ne.test(s) ? this.mouseHooks : je.test(s) ? this.keyHooks : {}), n = o.props ? this.props.concat(o.props) : this.props, e = new se.Event(a), t = n.length; t--;) i = n[t], e[i] = a[i];
		...
		simulate: function(e, t, i, n) {
			...
			n ? se.event.trigger(s, null, t) : se.event.dispatch.call(t, s), s.isDefaultPrevented() && i.preventDefault()
		}
	}, se.removeEvent = fe.removeEventListener ? function(e, t, i) {
		...
		se.event.special[e] = {
			...
			handle: function(e) {
				var i, n = this,
					s = e.relatedTarget,
					a = e.handleObj;
				return(!s || s !== n && !se.contains(n, s)) && (e.type = a.origType, i = a.handler.apply(this, arguments), e.type = t), i
			}
		}
	...
	Xe.optgroup = Xe.option, Xe.tbody = Xe.tfoot = Xe.colgroup = Xe.caption = Xe.thead, Xe.th = Xe.td, se.extend({
		clone: function(e, t, i) {
			...
			if(ie.html5Clone || se.isXMLDoc(e) || !He.test("<" + e.nodeName + ">") ? a = e.cloneNode(!0) : (Qe.innerHTML = e.outerHTML, Qe.removeChild(a = Qe.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || se.isXMLDoc(e)))
				for(n = g(a), r = g(e), o = 0; null != (s = r[o]); ++o) n[o] && C(s, n[o]);
			if(t)
				if(i)
					for(r = r || g(e), n = n || g(a), o = 0; null != (s = r[o]); o++) x(s, n[o]);
				else x(e, a);
			return n = g(a, "script"), n.length > 0 && _(n, !l && g(e, "script")), n = r = s = null, a
		},
		buildFragment: function(e, t, i, n) {
			for(var s, a, o, r, l, c, d, h = e.length, u = m(t), p = [], f = 0; h > f; f++)
				if(a = e[f], a || 0 === a)
				...
				if(!ie.leadingWhitespace && Le.test(a) && p.push(t.createTextNode(Le.exec(a)[0])), !ie.tbody)
					for(a = "table" !== l || Fe.test(a) ? "<table>" !== d[1] || Fe.test(a) ? 0 : r : r.firstChild, s = a && a.childNodes.length; s--;) se.nodeName(c = a.childNodes[s], "tbody") && !c.childNodes.length && a.removeChild(c);
				for(se.merge(p, r.childNodes), r.textContent = ""; r.firstChild;) r.removeChild(r.firstChild);
				r = u.lastChild
			} else p.push(t.createTextNode(a));
			for(r && u.removeChild(r), ie.appendChecked || se.grep(g(p, "input"), v), f = 0; a = p[f++];)
				if((!n || -1 === se.inArray(a, n)) && (o = se.contains(a.ownerDocument, a), r = g(u.appendChild(a), "script"), o && _(r), i))
					for(s = 0; a = r[s++];) Ye.test(a.type || "") && i.push(a);
			return r = null, u
		},
		cleanData: function(e, t) {
			for(var i, n, s, a, o = 0, r = se.expando, l = se.cache, c = ie.deleteExpando, d = se.event.special; null != (i = e[o]); o++)
				if((t || se.acceptData(i)) && (s = i[r], a = s && l[s])) {
					if(a.events)
						for(n in a.events) d[n] ? se.event.remove(i, n) : se.removeEvent(i, n, a.handle);
		...
		remove: function(e, t) {
			for(var i, n = e ? se.filter(e, this) : this, s = 0; null != (i = n[s]); s++) t || 1 !== i.nodeType || se.cleanData(g(i)), i.parentNode && (t && se.contains(i.ownerDocument, i) && _(g(i, "script")), i.parentNode.removeChild(i));
			return this
		},
		empty: function() {
		...
		html: function(e) {
			return Ie(this, function(e) {
				...
				if(!("string" != typeof e || qe.test(e) || !ie.htmlSerialize && He.test(e) || !ie.leadingWhitespace && Le.test(e) || Xe[(Re.exec(e) || ["", ""])[1].toLowerCase()])) {
					e = e.replace(We, "<$1></$2>");
					try {
						for(; n > i; i++) t = this[i] || {}, 1 === t.nodeType && (se.cleanData(g(t, !1)), t.innerHTML = e);
						t = 0
					} catch(s) {}
				}
		...
		replaceWith: function() {
			...
			return this.domManip(arguments, function(t) {
				e = this.parentNode, se.cleanData(g(this)), e && e.replaceChild(t, this)
		...
		domManip: function(e, t) {
			...
			if(c && (r = se.buildFragment(e, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
				for(a = se.map(g(r, "script"), b), s = a.length; c > l; l++) n = r, l !== h && (n = se.clone(n, !0, !0), s && se.merge(a, g(n, "script"))), t.call(this[l], n, l);
				if(s)
					for(o = a[a.length - 1].ownerDocument, se.map(a, w), l = 0; s > l; l++) n = a[l], Ye.test(n.type || "") && !se._data(n, "globalEval") && se.contains(o, n) && (n.src ? se._evalUrl && se._evalUrl(n.src) : se.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Ge, "")));
				r = i = null
			}
			return this
		}
		...
		se.fn[e] = function(e) {
			for(var i, n = 0, s = [], a = se(e), o = a.length - 1; o >= n; n++) i = n === o ? this : this.clone(!0), se(a[n])[t](i), Q.apply(s, i.get());
	...
	e.getComputedStyle ? (et = function(e) {
		...
		return i = i || et(e), o = i ? i.getPropertyValue(t) || i[t] : void 0, i && ("" !== o || se.contains(e.ownerDocument, e) || (o = se.style(e, t)), nt.test(o) && it.test(t) && (n = r.width, s = r.minWidth, a = r.maxWidth, r.minWidth = r.maxWidth = r.width = o, o = i.width, r.width = n, r.minWidth = s, r.maxWidth = a)), void 0 === o ? o : o + ""
	}) : fe.documentElement.currentStyle && (et = function(e) {
		return e.currentStyle
	}, tt = function(e, t, i) {
		var n, s, a, o, r = e.style;
		return i = i || et(e), o = i ? i[t] : void 0, null == o && r && r[t] && (o = r[t]), nt.test(o) && !st.test(t) && (n = r.left, s = e.runtimeStyle, a = s && s.left, a && (s.left = e.currentStyle.left), r.left = "fontSize" === t ? "1em" : o, o = r.pixelLeft + "px", r.left = n, a && (s.left = a)), void 0 === o ? o : o + "" || "auto"
	}), ! function() {
		function t() {
			var t, i, n, s;
	...
	se.extend({
		...
		css: function(e, t, i, n) {
			var s, a, o, r = se.camelCase(t);
			return t = se.cssProps[r] || (se.cssProps[r] = D(e.style, r)), o = se.cssHooks[t] || se.cssHooks[r], o && "get" in o && (a = o.get(e, !0, i)), void 0 === a && (a = tt(e, t, n)), "normal" === a && t in ht && (a = ht[t]), "" === i || i ? (s = parseFloat(a), i === !0 || se.isNumeric(s) ? s || 0 : a) : a
		}
		...
		set: function(e, t) {
			...
			i.zoom = 1, (t >= 1 || "" === t) && "" === se.trim(a.replace(at, "")) && i.removeAttribute && (i.removeAttribute("filter"), "" === t || n && !n.filter) || (i.filter = at.test(a) ? a.replace(at, s) : a + " " + s)
		}
		...
		init: function(e, t, i, n, s, a) {
			this.elem = e, this.prop = i, this.easing = s || "swing", this.options = t, this.start = this.now = this.cur(), this.end = n, this.unit = a || (se.cssNumber[i] ? "" : "px")
		},
		cur: function() {
		...
		run: function(e) {
			...
			return this.pos = t = this.options.duration ? se.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration) : e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : j.propHooks._default.set(this), this
		}
	...
	var pt, ft, mt = /^(?:toggle|show|hide)$/,
		...
		bt = {
			"*": [function(e, t) {
				...
				if(o && o[3] !== a) {
					a = a || o[3], s = s || [], o = +n || 1;
					do r = r || ".5", o /= r, se.style(i.elem, e, o + a); while (r !== (r = i.cur() / n) && 1 !== r && --l)
				}
	...
	se.Animation = se.extend(H, {
			tweener: function(e, t) {
				...
				for(var i, n = 0, s = e.length; s > n; n++) i = e[n], bt[i] = bt[i] || [], bt[i].unshift(t)
			},
			...
			stop: function(e, t, i) {
				...
				return "string" != typeof e && (i = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function() {
					...
					if(s) o[s] && o[s].stop && n(o[s]);
						...
						for(s in o) o[s] && o[s].stop && vt.test(s) && n(o[s]);
			...
			var e, t = se.timers,
				i = 0;
			for(pt = se.now(); i < t.length; i++) e = t[i], e() || t[i] !== e || t.splice(i--, 1);
			t.length || se.fx.stop(), pt = void 0
	...
	se.fn.extend({
		...
		valHooks: {
			...
			select: {
				get: function(e) {
					for(var t, i, n = e.options, s = e.selectedIndex, a = "select-one" === e.type || 0 > s, o = a ? null : [], r = a ? s + 1 : n.length, l = 0 > s ? r : a ? s : 0; r > l; l++)
				...
				set: function(e, t) {
					for(var i, n, s = e.options, a = se.makeArray(t), o = s.length; o--;)
	...
	se.fn.extend({
		...
		removeAttr: function(e, t) {
			var i, n, s = 0,
				a = t && t.match(be);
			if(a && 1 === e.nodeType)
				for(; i = a[s++];) n = se.propFix[i] || i, se.expr.match.bool.test(i) ? St && Tt || !kt.test(i) ? e[n] = !1 : e[se.camelCase("default-" + i)] = e[n] = !1 : se.attr(e, i, ""), e.removeAttribute(Tt ? i : n)
		},
		attrHooks: {
			type: {
				set: function(e, t) {
		...
		set: function(e, t, i) {
			return t === !1 ? se.removeAttr(e, i) : St && Tt || !kt.test(i) ? e.setAttribute(!Tt && se.propFix[i] || i, i) : e[se.camelCase("default-" + i)] = e[i] = !0, i
		}
	}, se.each(se.expr.match.bool.source.match(/\w+/g), function(e, t) {
		var i = Ct[t] || se.find.attr;
		Ct[t] = St && Tt || !kt.test(t) ? function(e, t, n) {
			var s, a;
			return n || (a = Ct[t], Ct[t] = s, s = null != i(e, t, n) ? t.toLowerCase() : null, Ct[t] = a), s
		} : function(e, t, i) {
	...
	se.fn.extend({
		...
		prop: function(e, t, i) {
			...
			if(e && 3 !== o && 8 !== o && 2 !== o) return a = 1 !== o || !se.isXMLDoc(e), a && (t = se.propFix[t] || t, s = se.propHooks[t]), void 0 !== i ? s && "set" in s && void 0 !== (n = s.set(e, i, t)) ? n : e[t] = i : s && "get" in s && null !== (n = s.get(e, t)) ? n : e[t]
		},
		propHooks: {
			tabIndex: {
				get: function(e) {
			...
			if(c)
				for(t = (e || "").match(be) || []; l > r; r++)
					if(i = this[r], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(It, " ") : "")) {
						...
						o = e ? se.trim(n) : "", i.className !== o && (i.className = o)
					}
			return this
		},
		toggleClass: function(e, t) {
			var i = typeof e;
			return "boolean" == typeof t && "string" === i ? t ? this.addClass(e) : this.removeClass(e) : this.each(se.isFunction(e) ? function(i) {
				se(this).toggleClass(e.call(this, i, this.className, t), t)
			} : function() {
				if("string" === i)
					for(var t, n = 0, s = se(this), a = e.match(be) || []; t = a[n++];) s.hasClass(t) ? s.removeClass(t) : s.addClass(t);
	...
	se.parseJSON = function(t) {
		...
		return i && i.documentElement && !i.getElementsByTagName("parsererror").length || se.error("Invalid XML: " + t), i
	};
	var Nt, At, Ot = /#.*$/,
		zt = /([?&])_=[^&]*/,
		$t = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
	...
	try {
		...
		At = fe.createElement("a"), At.href = "", At = At.href
	}
	Nt = Rt.exec(At.toLowerCase()) || [], se.extend({
		active: 0,
		lastModified: {},
		etag: {},
		ajaxSettings: {
		...
		ajax: function(e, t) {
			...
			var n, s, a, o, r, l, c, d, h = se.ajaxSetup({}, t),
				...
				_ = {
					...
					getResponseHeader: function(e) {
						...
						if(2 === b) {
							if(!d)
								for(d = {}; t = $t.exec(o);) d[t[1].toLowerCase()] = t[2];
							t = d[e.toLowerCase()]
						}
			...
			l = h.global, l && 0 === se.active++ && se.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Lt.test(h.type), a = h.url, h.hasContent || (h.data && (a = h.url += (Mt.test(a) ? "&" : "?") + h.data, delete h.data), h.cache === !1 && (h.url = zt.test(a) ? a.replace(zt, "$1_=" + Pt++) : a + (Mt.test(a) ? "&" : "?") + "_=" + Pt++)), h.ifModified && (se.lastModified[a] && _.setRequestHeader("If-Modified-Since", se.lastModified[a]), se.etag[a] && _.setRequestHeader("If-None-Match", se.etag[a])), (h.data && h.hasContent && h.contentType !== !1 || t.contentType) && _.setRequestHeader("Content-Type", h.contentType), _.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + qt + "; q=0.01" : "") : h.accepts["*"]);
			...
			if(c = W(Bt, h, t, _)) {
				_.readyState = 1, l && p.trigger("ajaxSend", [_, h]), h.async && h.timeout > 0 && (r = setTimeout(function() {
					_.abort("timeout")
				}, h.timeout));
				try {
					b = 1, c.send(v, i)
		...
		wrapInner: function(e) {
			return this.each(se.isFunction(e) ? function(t) {
	...
	}), ie.cors = !!Zt && "withCredentials" in Zt, Zt = ie.ajax = !!Zt, Zt && se.ajaxTransport(function(e) {
		if(!e.crossDomain || ie.cors) {
			...
			return {
				send: function(i, n) {
					...
					a.send(e.hasContent && e.data || null), t = function(i, s) {
						var r, l, c;
						if(t && (s || 4 === a.readyState))
							if(delete Jt[o], t = void 0, a.onreadystatechange = se.noop, s) 4 !== a.readyState && a.abort();
							else {
	...
	se.ajaxSetup({
		...
		return r || "jsonp" === t.dataTypes[0] ? (s = t.jsonpCallback = se.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, r ? t[r] = t[r].replace(ti, "$1" + s) : t.jsonp !== !1 && (t.url += (Mt.test(t.url) ? "&" : "?") + t.jsonp + "=" + s), t.converters["script json"] = function() {
			...
			e[s] = a, t[s] && (t.jsonpCallback = i.jsonpCallback, ei.push(s)), o && se.isFunction(a) && a(o[0]), o = a = void 0
		}), "script") : void 0
	...
	se.fn.load = function(e, t, i) {
		...
		var n, s, a, o = this,
			r = e.indexOf(" ");
		return r >= 0 && (n = se.trim(e.slice(r, e.length)), e = e.slice(0, r)), se.isFunction(t) ? (i = t, t = void 0) : t && "object" == typeof t && (a = "POST"), o.length > 0 && se.ajax({
			url: e,
			type: a,
			dataType: "html",
			data: t
		}).done(function(e) {
			s = arguments, o.html(n ? se("<div>").append(se.parseHTML(e)).find(n) : e)
	...
	se.offset = {
		setOffset: function(e, t, i) {
			var n, s, a, o, r, l, c, d = se.css(e, "position"),
				h = se(e),
				u = {};
			"static" === d && (e.style.position = "relative"), r = h.offset(), a = se.css(e, "top"), l = se.css(e, "left"), c = ("absolute" === d || "fixed" === d) && se.inArray("auto", [a, l]) > -1, c ? (n = h.position(), o = n.top, s = n.left) : (o = parseFloat(a) || 0, s = parseFloat(l) || 0), se.isFunction(t) && (t = t.call(e, i, r)), null != t.top && (u.top = t.top - r.top + o), null != t.left && (u.left = t.left - r.left + s), "using" in t ? t.using.call(e, u) : h.css(u)
		}
	}, se.fn.extend({
		offset: function(e) {
	...
	return se.noConflict = function(t) {
		return e.$ === se && (e.$ = ai), t && e.jQuery === se && (e.jQuery = si), se
	}, typeof t === Ce && (e.jQuery = e.$ = se), se
}),
function(e) {
	"use strict";
	var t = null,
		...
		a = {
			init: function(i) {
				t = e(this), i && e.extend(n, i), a.getData(), e(window).scroll(a.checkScroll);
				var o = {};
				return o.getPager = function() {
					...
					e && (n.params = e), n.pager = 1, a.getData()
			...
			getData: function() {
				...
				if(e.ajax({
						...
						async: !1,
						success: function(e) {
							s = "undefind" == e.totalPage ? 0 : e.totalPage, template.config("openTag", "<%"), template.config("closeTag", "%>");
							var a = template(n.template, e);
							n.pager > 1 ? t.append(a) : t.html(a), n.pager++, i = !1
						}
	...
	document.head.appendChild(function() {
		...
		return e.href = t + "need/layer.css", e.type = "text/css", e.rel = "styleSheet", e.id = "layermcss", e
	}());
	var o = {
		type: 0,
		shade: !0,
	...
	e.ready = {
		...
		e.addEventListener("touchmove", function() {
			...
			e.preventDefault(), i || t.call(this, e), i = !1
		}, !1)
	};
	var r = 0,
		l = ["layermbox"],
	...
	c.prototype.view = function() {
		...
		e.id = n.id = l[0] + r, n.setAttribute("class", l[0] + " " + l[0] + (t.type || 0)), n.setAttribute("index", r);
		var o = function() {
		...
		t.success && t.success(p), e.index = r++, e.action(t, p)
		...
		if(e.time && (ready.timer[i.index] = setTimeout(function() {
			...
			var n = t[s]("layermend")[0],
				a = function() {
					e.cancel && e.cancel(), d.close(i.index)
				};
			ready.touch(n, a), n.onclick = a
		}
		var o = function() {
		...
		if(e.btn)
			for(var r = t[s]("layermbtn")[0].children, l = r.length, c = 0; l > c; c++) ready.touch(r[c], o), r[c].onclick = o;
	...
	function i(i, n) {
		...
		function a(t) {
			...
			return o && (t = "$line=" + i + ";" + t), v(e(t), function(e) {
				if(e && !m[e]) {
					var t;
					t = "print" === e ? w : "include" === e ? _ : p[e] ? "$utils." + e : f[e] ? "$helpers." + e : "$data." + e, x += e + "=" + t + ",", m[e] = !0
				}
			}), t + "\n"
		}
		var o = n.debug,
		...
		try {
			...
			return S.prototype = p, S
		} catch(D) {
			throw D.temp = "function anonymous($data,$filename) {" + T + "}", D
		}
	}
	var n = function(e, t) {
	...
	var r = function(e, t) {
		...
		u = function(e, t) {
			var i, n;
			if(h(e))
				for(i = 0, n = e.length; n > i; i++) t.call(e, e[i], i, e);
			else
	...
	$.toJSON = "object" == typeof JSON && JSON.stringify ? JSON.stringify : function(e) {
		...
		if("undefined" !== a) {
			...
			if("date" === a) {
				...
				return o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), c < 10 && (c = "0" + c), d < 10 && (d = "0" + d), h < 10 && (h = "0" + h), u < 100 && (u = "0" + u), u < 10 && (u = "0" + u), '"' + l + "-" + o + "-" + r + "T" + c + ":" + d + ":" + h + "." + u + 'Z"'
			}
			if(t = [], $.isArray(e)) {
			...
			if("object" == typeof e) {
				for(i in e)
					if(hasOwn.call(e, i)) {
						...
						a = typeof e[i], "function" !== a && "undefined" !== a && (s = $.toJSON(e[i]), t.push(n + ":" + s))
					}
				return "{" + t.join(",") + "}"
			}
		}
...
function(e, t, i) {
	...
	function s() {
		return 0 === e("#Validform_msg").length && (o = e('<div id="Validform_msg"><div class="Validform_title">' + l.tit + '<a class="Validform_close" href="javascript:void(0);">&chi;</a></div><div class="Validform_info"></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>').appendTo("body"), o.find("a.Validform_close").click(function() {
			return o.hide(), r = !0, a && a.focus().addClass("Validform_error"), !1
		}).focus(function() {
			this.blur()
	...
	var c = function(t, n, a) {
		...
		return o.tipmsg = {
			w: {}
		}, o.forms = t, o.objects = [], a !== !0 && (t.each(function() {
			if("inited" == this.validform_inited) return !0;
			this.validform_inited = "inited";
			var t = this;
			t.settings = e.extend({}, n);
			var s = e(t);
			t.validform_status = "normal", s.data("tipmsg", o.tipmsg), s.delegate("[datatype]", "blur", function() {
				var e = arguments[1];
				c.util.check.call(this, s, e)
			}), s.delegate(":text", "keypress", function(e) {
				13 == e.keyCode && 0 == s.find(":submit").length && s.submit()
			}), c.util.enhance.call(s, t.settings.tiptype, t.settings.usePlugin, t.settings.tipSweep), t.settings.btnSubmit && s.find(t.settings.btnSubmit).bind("click", function() {
				return s.trigger("submit"), !1
			}), s.submit(function() {
	...
	c.defaults = {
		...
		getValue: function(t) {
			...
			return t.is(":radio") ? (n = s.find(":radio[name='" + t.attr("name") + "']:checked").val(), n = n === i ? "" : n) : t.is(":checkbox") ? (n = "", s.find(":checkbox[name='" + t.attr("name") + "']:checked").each(function() {
				n += e(this).val() + ","
			}), n = n === i ? "" : n) : n = t.val(), n = e.trim(n), c.util.isEmpty.call(t, n) ? "" : n
		},
		...
		usePlugin: function(t, i, n, s) {
			...
			if(a.find("input[plugin='swfupload']").length && "undefined" != typeof swfuploadhandler) {
				...
				o = e.extend(!0, {}, t.swfupload, o), a.find("input[plugin='swfupload']").each(function(t) {
		...
		getNullmsg: function(e) {
			...
			if(s = i.siblings(s).eq(0).text() || i.siblings().find(s).eq(0).text() || i.parent().siblings(s).eq(0).text() || i.parent().siblings().find(s).eq(0).text(), s = s.replace(/\s(?![a-zA-Z])/g, "").match(n), s = s ? s.join("") : [""], n = /\{(.+)\|(.+)\}/, t = e.data("tipmsg").s || l.s, "" != s) {
				if(t = t.replace(/\{0\|(.+)\}/, s), i.attr("recheck")) return t = t.replace(/\{(.+)\}/, ""), i.attr("nullmsg", t), t
			} else t = i.is(":checkbox,:radio,select") ? t.replace(/\{0\|(.+)\}/, "") : t.replace(/\{0\|(.+)\}/, "$1");
			return t = i.is(":checkbox,:radio,select") ? t.replace(n, "$2") : t.replace(n, "$1"), i.attr("nullmsg", t), t
		},
		getErrormsg: function(t, i, n) {
			...
			for(var h in d)
				if(h.indexOf(c[1]) != -1 && o.test(h)) return s = (t.data("tipmsg").w[h] || l.w[h]).replace(r, "$1" + c[3] + "$2" + c[4] + "$3"), t.data("tipmsg").w[c[0]] = s, s;
		...
		_regcheck: function(e, t, n, s) {
			...
			if(r.test(e)) {
				var u = e.match(r)[0].slice(1, -1),
					...
					f = RegExp(u, p);
				o = f.test(t)
			} else if("[object Function]" == c.util.toString.call(c.util.dataType[e])) o = c.util.dataType[e](t, n, s, c.util.dataType), o === !0 || o === i ? o = !0 : (a = o, o = !1);
			else {
					...
					if(g) {
						for(var v in c.util.dataType)
							if(m = v.match(d), m && g[1] === m[1]) {
								...
								y = y.replace(/\/[mgi]*/g, "/").replace(b, "{" + g[2] + "," + g[3] + "}").replace(/^\//, "").replace(/\/$/, ""), c.util.dataType[e] = new RegExp(y, p);
								break
							}
					} else o = !1, a = s.data("tipmsg").undef || l.undef
				}
			...
			} else a = a || n.attr("errormsg") || c.util.getErrormsg.call(n, s, e), c.util.isEmpty.call(n, t) && (a = n.attr("nullmsg") || c.util.getNullmsg.call(n, s));
			return {
				passed: o,
				type: h,
				info: a
		...
		parseDatatype: function(e) {
			var t = /\/.+?\/[mgi]*(?=(,|$|\||\s))|[\w\*-]+/g,
				...
				a = 0;
			s[0] = [], s[0].push(i[0]);
			for(var o = 0; o < n.length; o++) "|" == n[o] && (a++, s[a] = []), s[a].push(i[o + 1]);
			return s
		},
		showmsg: function(t, s, a, l) {
			if(t != i && ("bycheck" != l || !a.sweep || (!a.obj || a.obj.is(".Validform_error")) && "function" != typeof s)) {
				...
				(1 == s || "byajax" == l && 4 != s) && o.find(".Validform_info").html(t), (1 == s && "bycheck" != l && 2 != a.type || "byajax" == l && 4 != s) && (r = !1, o.find(".iframe").css("height", o.outerHeight()), o.show(), n(o, 100)), 2 == s && a.obj && (a.obj.parent().next().find(".Validform_checktip").html(t), c.util.cssctl(a.obj.parent().next().find(".Validform_checktip"), a.type)), 3 != s && 4 != s || !a.obj || (a.obj.siblings(".Validform_checktip").html(t), c.util.cssctl(a.obj.siblings(".Validform_checktip"), a.type))
			}
		},
		cssctl: function(e, t) {
			switch(t) {
		...
		check: function(t, i, n) {
			...
			var d;
			if(a = d = e(this), !r.passed) return c.util.abort.call(d[0]), n || (c.util.showmsg.call(t, r.info, s.tiptype, {
				obj: e(this),
				type: r.type,
				sweep: s.tipSweep
			}, "bycheck"), !s.tipSweep && d.addClass("Validform_error")), !1;
			...
			if(h && !c.util.isEmpty.call(e(this), o) && !n) {
				...
				u[0].validform_valid = "posting", u[0].validform_ckvalue = o, c.util.showmsg.call(t, t.data("tipmsg").c || l.c, s.tiptype, {
					obj: u,
					type: 1,
					sweep: s.tipSweep
				...
				var p = e.extend(!0, {}, s.ajaxurl || {}),
					f = {
						...
						error: function(e) {
							...
							return u[0].validform_valid = e.statusText, d[0].validform_ajax = null, !0
						}
					};
				if(p.success) {
					var m = p.success;
				...
				return p = e.extend({}, f, p, {
					dataType: "json"
				}), d[0].validform_ajax = e.ajax(p), "ajax"
			}
			return h && c.util.isEmpty.call(e(this), o) && (c.util.abort.call(d[0]), d[0].validform_valid = "true"), n || (c.util.showmsg.call(t, r.info, s.tiptype, {
				obj: e(this),
				type: r.type,
				sweep: s.tipSweep
			}, "bycheck"), d.removeClass("Validform_error")), a = null, !0
		},
		submitForm: function(t, i, n, s, o) {
			...
			if(r.find("[datatype]").each(function() {
					...
					if(a = n = e(this), h = c.util.regcheck.call(r, e(this).attr("datatype"), s, e(this)), !h.passed) return c.util.showmsg.call(r, h.info, t.tiptype, {
						...
						type: h.type,
						sweep: t.tipSweep
					}), n.addClass("Validform_error"), t.showAllError ? (u && (u = !1), !0) : (n.focus(), u = !1, !1);
					if(e(this).attr("ajaxurl") && !c.util.isEmpty.call(e(this), s)) {
						if("true" !== this.validform_valid) {
							...
							return c.util.showmsg.call(r, r.data("tipmsg").v || l.v, t.tiptype, {
								...
								type: 3,
								sweep: t.tipSweep
							}), n.addClass("Validform_error"), o.trigger("blur", ["postform"]), t.showAllError ? (u && (u = !1), !0) : (u = !1, !1)
						}
					...
					c.util.showmsg.call(r, h.info, t.tiptype, {
						...
						type: h.type,
						sweep: t.tipSweep
					}), n.removeClass("Validform_error"), a = null
				...
				if(r[0].validform_status = "posting", !t.ajaxPost && "ajaxPost" !== s) {
					...
					var n = n || t.url;
					return n && r.attr("action", n), t.callback && t.callback(r)
				}
				...
				if(f.url = n || f.url || t.url || r.attr("action"), c.util.showmsg.call(r, r.data("tipmsg").p || l.p, t.tiptype, {
					...
					f.success = function(i) {
						t.callback && t.callback(i), r[0].validform_ajax = null, "y" === e.trim(i.status) ? r[0].validform_status = "posted" : r[0].validform_status = "normal", m(i, r)
					}
				}
				if(f.error) {
					var g = f.error;
					f.error = function(e) {
						t.callback && t.callback(e), r[0].validform_status = "normal", r[0].validform_ajax = null, g(e, r)
					}
				}
				var v = {
					type: "POST",
					...
					success: function(i) {
						"y" === e.trim(i.status) ? (r[0].validform_status = "posted", c.util.showmsg.call(r, i.info, t.tiptype, {
							...
							type: 3,
							sweep: t.tipSweep
						}, "byajax")), t.callback && t.callback(i), r[0].validform_ajax = null
					},
					error: function(e) {
						var i = "status: " + e.status + "; statusText: " + e.statusText;
						c.util.showmsg.call(r, i, t.tiptype, {
							...
							type: 3,
							sweep: t.tipSweep
						}, "byajax"), t.callback && t.callback(e), r[0].validform_status = "normal", r[0].validform_ajax = null
					}
				};
				f = e.extend({}, v, f, {
					dataType: "json"
	...
	}, e.Datatype = c.util.dataType, c.prototype = {
		...
		ajaxPost: function(t, i, n) {
			...
			return e(a.forms).each(function() {
				1 != this.settings.tiptype && 2 != this.settings.tiptype && 3 != this.settings.tiptype || s(), c.util.submitForm.call(e(a.forms[0]), this.settings, t, n, "ajaxPost", i)
			}), this
		},
		submitForm: function(t, n) {
			...
			return e(s.forms).each(function() {
				...
				s === i && (s = !0), s === !0 && this.submit()
			}), this
		},
		resetForm: function() {
			var t = this;
			return c.util.resetForm.call(e(t.forms)), this
		},
		abort: function() {
			var t = this;
			return e(t.forms).each(function() {
		...
		config: function(t) {
			var i = this;
			return t = t || {}, e(i.forms).each(function() {
				var i = e(this);
				this.settings = e.extend(!0, this.settings, t), c.util.enhance.call(i, this.settings.tiptype, this.settings.usePlugin, this.settings.tipSweep)
			}), this
		}
	}, e.fn.Validform = function(e) {
		return new c(this, e)
	}, e.Showmsg = function(e) {
		s(), c.util.showmsg.call(t, e, 1, {})
	}, e.Hidemsg = function() {
		o.hide(), r = !0
	}
...
if("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(e) {
	...
	function t(t) {
		return this.each(function() {
			var n = e(this),
				s = n.data("bs.button"),
				a = "object" == typeof t && t;
			s || n.data("bs.button", s = new i(this, a)), "toggle" == t ? s.toggle() : t && s.setState(t)
		})
	}
	var i = function(t, n) {
	...
	i.VERSION = "3.3.6", i.DEFAULTS = {
		...
		var i = "disabled",
			...
			a = n.data();
		t += "Text", null == a.resetText && n.data("resetText", n[s]()), setTimeout(e.proxy(function() {
			n[s](null == a[t] ? this.options[t] : a[t]), "loadingText" == t ? (this.isLoading = !0, n.addClass(i).attr(i, i)) : this.isLoading && (this.isLoading = !1, n.removeClass(i).removeAttr(i))
		}, this), 0)
	...
	function t(t) {
		return this.each(function() {
			...
			s || n.data("bs.carousel", s = new i(this, a)), "number" == typeof t ? s.to(t) : o ? s[o]() : a.interval && s.pause().cycle()
		})
	}
	var i = function(t, i) {
	...
	var s = function(i) {
		...
		if(a.hasClass("carousel")) {
			...
			r && (o.interval = !1), t.call(a, o), r && a.data("bs.carousel").to(r), i.preventDefault()
		}
	};
	...
	function i(t) {
		return this.each(function() {
			...
			!s && a.toggle && /show|hide/.test(t) && (a.toggle = !1), s || i.data("bs.collapse", s = new n(this, a)), "string" == typeof t && s[t]()
		})
	}
	var n = function(t, i) {
	...
	function t(t, n) {
		return this.each(function() {
			...
			a || s.data("bs.modal", a = new i(this, o)), "string" == typeof t ? a[t](n) : o.show && a.show(n)
		})
	}
	var i = function(t, i) {
	...
	e.fn.modal = t, e.fn.modal.Constructor = i, e.fn.modal.noConflict = function() {
		...
		n.is("a") && i.preventDefault(), a.one("show.bs.modal", function(e) {
	...
	i.VERSION = "3.3.6", i.TRANSITION_DURATION = 150, i.DEFAULTS = {
		...
		if(this.hasContent() && this.enabled) {
			...
			if(c) {
				...
				r = "bottom" == r && d.bottom + u > f.bottom ? "top" : "top" == r && d.top - u < f.top ? "bottom" : "right" == r && d.right + h > f.width ? "left" : "left" == r && d.left - h < f.left ? "right" : r, a.removeClass(p).addClass(r)
			}
		...
		return this.$element.trigger(o), o.isDefaultPrevented() ? void 0 : (a.removeClass("in"), e.support.transition && a.hasClass("fade") ? a.one("bsTransitionEnd", n).emulateTransitionEnd(i.TRANSITION_DURATION) : n(), this.hoverState = null, this)
	...
	function i(i) {
		return this.each(function() {
			var n = e(this),
				...
				a = "object" == typeof i && i;
			s || n.data("bs.scrollspy", s = new t(this, a)), "string" == typeof i && s[i]()
		})
	}
	t.VERSION = "3.3.6", t.DEFAULTS = {
		...
		if(o && t < s[0]) return this.activeTarget = null, this.clear();
	...
	function t(t) {
		return this.each(function() {
			var n = e(this),
				s = n.data("bs.affix"),
				a = "object" == typeof t && t;
			s || n.data("bs.affix", s = new i(this, a)), "string" == typeof t && s[t]()
		})
	}
	var i = function(t, n) {
	...
	var t, i = function(e, s) {
		...
		function u(e, i) {
			e = t(e);
			var n, s, o;
			n = e.attr("data-swiper-parallax") || "0", s = e.attr("data-swiper-parallax-x"), o = e.attr("data-swiper-parallax-y"), s || o ? (s = s || "0", o = o || "0") : a() ? (s = n, o = "0") : (o = n, s = "0"), s = s.indexOf("%") >= 0 ? parseInt(s, 10) * i + "%" : s * i + "px", o = o.indexOf("%") >= 0 ? parseInt(o, 10) * i + "%" : o * i + "px", e.transform("translate3d(" + s + ", " + o + ",0px)")
		}
		...
		for(var b in f)
			...
			for(var w in f[b]) "undefined" == typeof s[b][w] && (s[b][w] = f[b][w]);
		var _ = this;
		if(_.params = s, _.originalParams = g, _.classNames = [], "undefined" != typeof t && "undefined" != typeof n && (t = n), ("undefined" != typeof t || (t = "undefined" == typeof n ? window.Dom7 || window.Zepto || window.jQuery : n)) && (_.$ = t, _.currentBreakpoint = void 0, _.getActiveBreakpoint = function() {
			...
			_.container[0].swiper = _, _.container.data("swiper", _), _.classNames.push("swiper-container-" + _.params.direction), _.params.freeMode && _.classNames.push("swiper-container-free-mode"), _.support.flexbox || (_.classNames.push("swiper-container-no-flexbox"), _.params.slidesPerColumn = 1), _.params.autoHeight && _.classNames.push("swiper-container-autoheight"), (_.params.parallax || _.params.watchSlidesVisibility) && (_.params.watchSlidesProgress = !0), ["cube", "coverflow"].indexOf(_.params.effect) >= 0 && (_.support.transforms3d ? (_.params.watchSlidesProgress = !0, _.classNames.push("swiper-container-3d")) : _.params.effect = "slide"), "slide" !== _.params.effect && _.classNames.push("swiper-container-" + _.params.effect), "cube" === _.params.effect && (_.params.resistanceRatio = 0, _.params.slidesPerView = 1, _.params.slidesPerColumn = 1, _.params.slidesPerGroup = 1, _.params.centeredSlides = !1, _.params.spaceBetween = 0, _.params.virtualTranslate = !0, _.params.setWrapperSize = !1), "fade" === _.params.effect && (_.params.slidesPerView = 1, _.params.slidesPerColumn = 1, _.params.slidesPerGroup = 1, _.params.watchSlidesProgress = !0, _.params.spaceBetween = 0, "undefined" == typeof m && (_.params.virtualTranslate = !0)), _.params.grabCursor && _.support.touch && (_.params.grabCursor = !1), _.wrapper = _.container.children("." + _.params.wrapperClass), _.params.pagination && (_.paginationContainer = t(_.params.pagination), _.params.paginationClickable && _.paginationContainer.addClass("swiper-pagination-clickable")), _.rtl = a() && ("rtl" === _.container[0].dir.toLowerCase() || "rtl" === _.container.css("direction")), _.rtl && _.classNames.push("swiper-container-rtl"), _.rtl && (_.wrongRTL = "-webkit-box" === _.wrapper.css("display")), _.params.slidesPerColumn > 1 && _.classNames.push("swiper-container-multirow"), _.device.android && _.classNames.push("swiper-container-android"), _.container.addClass(_.classNames.join(" ")), _.translate = 0, _.progress = 0, _.velocity = 0, _.lockSwipeToNext = function() {
			...
			}, _.params.grabCursor && (_.container[0].style.cursor = "move", _.container[0].style.cursor = "-webkit-grab", _.container[0].style.cursor = "-moz-grab", _.container[0].style.cursor = "grab"), _.imagesToLoad = [], _.imagesLoaded = 0, _.loadImage = function(e, t, i, n, s) {
				function a() {
					s && s()
				}
				var o;
				...
				for(e = 0; e < _.slides.length; e++) {
					...
					if(_.params.slidesPerColumn > 1) {
						...
						"column" === _.params.slidesPerColumnFill ? (f = Math.floor(e / c), m = e - f * c, (f > h || f === h && m === c - 1) && ++m >= c && (m = 0, f++), p = f + m * r / c, u.css({
							...
							"-webkit-order": p,
							order: p
						})) : (m = Math.floor(e / d), f = e - m * d), u.css({
				...
				0 === _.snapGrid.length && (_.snapGrid = [0]), 0 !== _.params.spaceBetween && (a() ? _.rtl ? _.slides.css({
					marginLeft: t + "px"
				}) : _.slides.css({
					marginRight: t + "px"
				}) : _.slides.css({
				...
				if(_.updateContainerSize(), _.updateSlidesSize(), _.updateProgress(), _.updatePagination(), _.updateClasses(), _.params.scrollbar && _.scrollbar && _.scrollbar.set(), e) {
					var i, n;
					_.controller && _.controller.spline && (_.controller.spline = void 0), _.params.freeMode ? (t(), _.params.autoHeight && _.updateAutoHeight()) : (i = ("auto" === _.params.slidesPerView || _.params.slidesPerView > 1) && _.isEnd && !_.params.centeredSlides ? _.slideTo(_.slides.length - 1, 0, !1, !0) : _.slideTo(_.activeIndex, 0, !1, !0), i || t())
				...
				if(_.params.allowSwipeToPrev = _.params.allowSwipeToNext = !0, _.updateContainerSize(), _.updateSlidesSize(), ("auto" === _.params.slidesPerView || _.params.freeMode || e) && _.updatePagination(), _.params.scrollbar && _.scrollbar && _.scrollbar.set(), _.controller && _.controller.spline && (_.controller.spline = void 0), _.params.freeMode) {
					...
					_.setWrapperTranslate(n), _.updateActiveIndex(), _.updateClasses(), _.params.autoHeight && _.updateAutoHeight()
			...
			window.navigator.pointerEnabled ? x = ["pointerdown", "pointermove", "pointerup"] : window.navigator.msPointerEnabled && (x = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), _.touchEvents = {
				...
				var i = l(e, "." + _.params.slideClass),
					n = !1;
				if(i)
					for(var s = 0; s < _.slides.length; s++) _.slides[s] === i && (n = !0);
				...
				if(_.clickedSlide = i, _.clickedIndex = t(i).index(), _.params.slideToClickedSlide && void 0 !== _.clickedIndex && _.clickedIndex !== _.activeIndex) {
					...
					if(_.params.loop) {
						...
						a = t(_.clickedSlide).attr("data-swiper-slide-index"), _.params.centeredSlides ? o < _.loopedSlides - _.params.slidesPerView / 2 || o > _.slides.length - _.loopedSlides + _.params.slidesPerView / 2 ? (_.fixLoop(), o = _.wrapper.children("." + _.params.slideClass + '[data-swiper-slide-index="' + a + '"]:not(.swiper-slide-duplicate)').eq(0).index(), setTimeout(function() {
							_.slideTo(o)
			...
			if(_.onTouchStart = function(e) {
						...
						if(!_.params.swipeHandler || l(e, _.params.swipeHandler)) {
							...
							if(!(_.device.ios && _.params.iOSEdgeSwipeDetection && i <= _.params.iOSEdgeSwipeThreshold)) {
								if(C = !0, k = !1, T = !0, D = void 0, $ = void 0, _.touches.startX = i, _.touches.startY = n, S = Date.now(), _.allowClick = !0, _.updateContainerSize(), _.swipeDirection = void 0, _.params.threshold > 0 && (P = !1), "touchstart" !== e.type) {
									var s = !0;
									t(e.target).is(N) && (s = !1), document.activeElement && t(document.activeElement).is(N) && document.activeElement.blur(), s && e.preventDefault()
								}
					...
					if(e.originalEvent && (e = e.originalEvent), !(z && "mousemove" === e.type || e.preventedByNestedSwiper)) {
						if(_.params.onlyExternal) return _.allowClick = !1, void(C && (_.touches.startX = _.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, _.touches.startY = _.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, S = Date.now()));
						if(z && document.activeElement && e.target === document.activeElement && t(e.target).is(N)) return k = !0, void(_.allowClick = !1);
								...
								if($ || !_.browser.ieTouch) {
									...
									if(n > 0 && E > _.minTranslate() ? (o = !1, _.params.resistance && (E = _.minTranslate() - 1 + Math.pow(-_.minTranslate() + I + n, _.params.resistanceRatio))) : 0 > n && E < _.maxTranslate() && (o = !1, _.params.resistance && (E = _.maxTranslate() + 1 - Math.pow(_.maxTranslate() - I - n, _.params.resistanceRatio))), o && (e.preventedByNestedSwiper = !0), !_.params.allowSwipeToNext && "next" === _.swipeDirection && I > E && (E = I), !_.params.allowSwipeToPrev && "prev" === _.swipeDirection && E > I && (E = I), _.params.followFinger) {
										if(_.params.threshold > 0) {
											...
											if(!P) return P = !0, _.touches.startX = _.touches.currentX, _.touches.startY = _.touches.currentY, E = I, void(_.touches.diff = a() ? _.touches.currentX - _.touches.startX : _.touches.currentY - _.touches.startY)
										}(_.params.freeMode || _.params.watchSlidesProgress) && _.updateActiveIndex(), _.params.freeMode && (0 === O.length && O.push({
											position: _.touches[a() ? "startX" : "startY"],
											time: S
										}), O.push({
											position: _.touches[a() ? "currentX" : "currentY"],
											time: (new window.Date).getTime()
										})), _.updateProgress(E), _.setWrapperTranslate(E)
									}
								}
							}
						}
					...
					if(e.originalEvent && (e = e.originalEvent), T && _.emit("onTouchEnd", _, e), T = !1, C) {
						...
						if(s = _.params.followFinger ? _.rtl ? _.translate : -_.translate : -E, _.params.freeMode) {
							...
							if(_.params.freeModeMomentum) {
								...
								if(h < _.maxTranslate()) _.params.freeModeMomentumBounce ? (h + _.maxTranslate() < -f && (h = _.maxTranslate() - f), u = _.maxTranslate(), p = !0, j = !0) : h = _.maxTranslate();
									...
									h = Math.abs(_.snapGrid[m] - h) < Math.abs(_.snapGrid[m - 1] - h) || "next" === _.swipeDirection ? _.snapGrid[m] : _.snapGrid[m - 1], _.rtl || (h = -h)
								}
								...
								_.params.freeModeMomentumBounce && p ? (_.updateProgress(u), _.setWrapperTransition(c), _.setWrapperTranslate(h), _.onTransitionStart(), _.animating = !0, _.wrapper.transitionEnd(function() {
									...
									_ && _.onTransitionEnd()
								}))) : _.updateProgress(h), _.updateActiveIndex()
							}
						...
						if(n > _.params.longSwipesMs) {
							...
							"next" === _.swipeDirection && (w >= _.params.longSwipesRatio ? _.slideTo(y + _.params.slidesPerGroup) : _.slideTo(y)), "prev" === _.swipeDirection && (w > 1 - _.params.longSwipesRatio ? _.slideTo(y + _.params.slidesPerGroup) : _.slideTo(y))
						} else {
					...
					_.params.autoplay && _.autoplaying && (n || !_.params.autoplayDisableOnInteraction ? _.pauseAutoplay(t) : _.stopAutoplay()), _.updateProgress(s);
					...
					"undefined" == typeof e && (e = !0), _.lazy && _.lazy.onTransitionStart(), e && (_.emit("onTransitionStart", _), _.activeIndex !== _.previousIndex && (_.emit("onSlideChangeStart", _), _.activeIndex > _.previousIndex ? _.emit("onSlideNextStart", _) : _.emit("onSlidePrevStart", _)))
				}, _.onTransitionEnd = function(e) {
					_.animating = !1, _.setWrapperTransition(0), "undefined" == typeof e && (e = !0), _.lazy && _.lazy.onTransitionEnd(), e && (_.emit("onTransitionEnd", _), _.activeIndex !== _.previousIndex && (_.emit("onSlideChangeEnd", _), _.activeIndex > _.previousIndex ? _.emit("onSlideNextEnd", _) : _.emit("onSlidePrevEnd", _))), _.params.hashnav && _.hashnav && _.hashnav.setHash()
					...
					var n = 0,
						s = 0,
						r = 0;
					a() ? n = _.rtl ? -e : e : s = e, _.params.roundLengths && (n = o(n), s = o(s)), _.params.virtualTranslate || (_.support.transforms3d ? _.wrapper.transform("translate3d(" + n + "px, " + s + "px, " + r + "px)") : _.wrapper.transform("translate(" + n + "px, " + s + "px)")), _.translate = a() ? n : s;
					var l, c = _.maxTranslate() - _.minTranslate();
					l = 0 === c ? 0 : (e - _.minTranslate()) / c, l !== _.progress && _.updateProgress(e), t && _.updateActiveIndex(), "slide" !== _.params.effect && _.effects[_.params.effect] && _.effects[_.params.effect].setTranslate(_.translate), _.params.parallax && _.parallax && _.parallax.setTranslate(_.translate), _.params.scrollbar && _.scrollbar && _.scrollbar.setTranslate(_.translate), _.params.control && _.controller && _.controller.setTranslate(_.translate, i), _.emit("onSetTranslate", _, _.translate)
				}, _.getTranslate = function(e, t) {
					var i, n, s, a;
					return "undefined" == typeof t && (t = "x"), _.params.virtualTranslate ? _.rtl ? -_.translate : _.translate : (s = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (n = s.transform || s.webkitTransform, n.split(",").length > 6 && (n = n.split(", ").map(function(e) {
						return e.replace(",", ".")
					...
					return "undefined" == typeof e && (e = a() ? "x" : "y"), _.getTranslate(_.wrapper[0], e)
				}, _.observers = [], _.initObservers = function() {
					if(_.params.observeParents)
						for(var e = _.container.parents(), t = 0; t < e.length; t++) c(e[t]);
					c(_.container[0], {
						childList: !1
					}), c(_.wrapper[0], {
						attributes: !1
					...
					"auto" !== _.params.slidesPerView || _.params.loopedSlides || (_.params.loopedSlides = e.length), _.loopedSlides = parseInt(_.params.loopedSlides || _.params.slidesPerView, 10), _.loopedSlides = _.loopedSlides + _.params.loopAdditionalSlides,
						_.loopedSlides > e.length && (_.loopedSlides = e.length);
					var i, n = [],
						s = [];
					for(e.each(function(i, a) {
							var o = t(this);
							i < _.loopedSlides && s.push(a), i < e.length && i >= e.length - _.loopedSlides && n.push(a), o.attr("data-swiper-slide-index", i)
					...
					cube: {
						setTranslate: function() {
							...
							for(var n = 0; n < _.slides.length; n++) {
								...
								var l = Math.max(Math.min(s[0].progress, 1), -1),
									...
									d = 0,
									h = 0;
								n % 4 === 0 ? (c = 4 * -r * _.size, h = 0) : (n - 1) % 4 === 0 ? (c = 0, h = 4 * -r * _.size) : (n - 2) % 4 === 0 ? (c = _.size + 4 * r * _.size, h = _.size) : (n - 3) % 4 === 0 && (c = -_.size, h = 3 * _.size + 4 * _.size * r), _.rtl && (c = -c), a() || (d = c, c = 0);
								...
								if(1 >= l && l > -1 && (i = 90 * n + 90 * l, _.rtl && (i = 90 * -n - 90 * l)), s.transform(u), _.params.cube.slideShadows) {
									...
									0 === p.length && (p = t('<div class="swiper-slide-shadow-' + (a() ? "left" : "top") + '"></div>'), s.append(p)), 0 === f.length && (f = t('<div class="swiper-slide-shadow-' + (a() ? "right" : "bottom") + '"></div>'), s.append(f)), s[0].progress, p.length && (p[0].style.opacity = -s[0].progress), f.length && (f[0].style.opacity = s[0].progress)
								}
							}
							if(_.wrapper.css({
								...
								if(a()) e.transform("translate3d(0px, " + (_.width / 2 + _.params.cube.shadowOffset) + "px, " + -_.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + _.params.cube.shadowScale + ")");
								else {
						...
						setTransition: function(e) {
							_.slides.transition(e).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(e), _.params.cube.shadow && !a() && _.container.find(".swiper-cube-shadow").transition(e)
						}
					},
					coverflow: {
						setTranslate: function() {
							for(var e = _.translate, i = a() ? -e + _.width / 2 : -e + _.height / 2, n = a() ? _.params.coverflow.rotate : -_.params.coverflow.rotate, s = _.params.coverflow.depth, o = 0, r = _.slides.length; r > o; o++) {
								...
								Math.abs(g) < .001 && (g = 0), Math.abs(m) < .001 && (m = 0), Math.abs(f) < .001 && (f = 0), Math.abs(u) < .001 && (u = 0), Math.abs(p) < .001 && (p = 0);
								...
								if(l.transform(v), l[0].style.zIndex = -Math.abs(Math.round(h)) + 1, _.params.coverflow.slideShadows) {
									...
									0 === y.length && (y = t('<div class="swiper-slide-shadow-' + (a() ? "left" : "top") + '"></div>'), l.append(y)), 0 === b.length && (b = t('<div class="swiper-slide-shadow-' + (a() ? "right" : "bottom") + '"></div>'), l.append(b)), y.length && (y[0].style.opacity = h > 0 ? h : 0), b.length && (b[0].style.opacity = -h > 0 ? -h : 0)
								}
							}
							if(_.browser.ie) {
					...
					setDragPosition: function(e) {
						...
						s > n ? n = s : n > o && (n = o), n = -n / t.moveDivider, _.updateProgress(n), _.setWrapperTranslate(n, !0)
					},
					...
					set: function() {
						if(_.params.scrollbar) {
							var e = _.scrollbar;
							e.track = t(_.params.scrollbar), e.drag = e.track.find(".swiper-scrollbar-drag"), 0 === e.drag.length && (e.drag = t('<div class="swiper-scrollbar-drag"></div>'), e.track.append(e.drag)), e.drag[0].style.width = "", e.drag[0].style.height = "", e.trackSize = a() ? e.track[0].offsetWidth : e.track[0].offsetHeight, e.divider = _.size / _.virtualSize, e.moveDivider = e.divider * (e.trackSize / _.size), e.dragSize = e.trackSize * e.divider, a() ? e.drag[0].style.width = e.dragSize + "px" : e.drag[0].style.height = e.dragSize + "px", e.divider >= 1 ? e.track[0].style.display = "none" : e.track[0].style.display = "", _.params.scrollbarHide && (e.track[0].style.opacity = 0)
						}
					},
					setTranslate: function() {
						if(_.params.scrollbar) {
					...
					setTranslate: function(e, t) {
						...
						if(_.isArray(o))
							for(var r = 0; r < o.length; r++) o[r] !== t && o[r] instanceof i && n(o[r]);
					...
					setTransition: function(e, t) {
						...
						if(_.isArray(a))
							for(s = 0; s < a.length; s++) a[s] !== t && a[s] instanceof i && n(a[s]);
			...
			return _.callPlugins = function(e) {
				...
				var i;
				if(e = p(e), "undefined" == typeof t) return _.emitterEventListeners[e] = [], _;
	...
	for(var n = (function() {
					...
					if(t)
						if("string" == typeof t) {
							...
							if(r.indexOf("<") >= 0 && r.indexOf(">") >= 0) {
								...
								for(a = i || "#" !== t[0] || t.match(/[ .<>:~]/) ? (i || document).querySelectorAll(t) : [document.getElementById(t.split("#")[1])], s = 0; s < a.length; s++) a[s] && n.push(a[s])
			...
			return e.prototype = {
					...
					on: function(e, i, n, s) {
						function a(e) {
							...
							if(t(s).is(i)) n.call(s, e);
								...
								for(var a = t(s).parents(), o = 0; o < a.length; o++) t(a[o]).is(i) && n.call(a[o], e)
						}
						var o, r, l = e.split(" ");
						for(o = 0; o < this.length; o++)
							if("function" == typeof i || i === !1)
								for("function" == typeof i && (n = arguments[1], s = arguments[2] || !1), r = 0; r < l.length; r++) this[o].addEventListener(l[r], n, s);
							else
					...
					off: function(e, t, i, n) {
						for(var s = e.split(" "), a = 0; a < s.length; a++)
							for(var o = 0; o < this.length; o++)
								if("function" == typeof t || t === !1) "function" == typeof t && (i = arguments[1], n = arguments[2] || !1), this[o].removeEventListener(s[a], i, n);
								else if(this[o].dom7LiveListeners)
							for(var r = 0; r < this[o].dom7LiveListeners.length; r++) this[o].dom7LiveListeners[r].listener === i && this[o].removeEventListener(s[a], this[o].dom7LiveListeners[r].liveListener, n);
						return this
					},
					once: function(e, t, i, n) {
						...
						var a = this;
						"function" == typeof t && (t = !1, i = arguments[1], n = arguments[2]), a.on(e, t, s, n)
					},
					trigger: function(e, t) {
						for(var i = 0; i < this.length; i++) {
							var n;
					...
					transitionEnd: function(e) {
						function t(a) {
							if(a.target === this)
								for(e.call(this, a), i = 0; i < n.length; i++) s.off(n[i], t)
						}
					...
					find: function(t) {
						for(var i = [], n = 0; n < this.length; n++)
							for(var s = this[n].querySelectorAll(t), a = 0; a < s.length; a++) i.push(s[a]);
						return new e(i)
					},
					children: function(i) {
						for(var n = [], s = 0; s < this.length; s++)
							for(var a = this[s].childNodes, o = 0; o < a.length; o++) i ? 1 === a[o].nodeType && t(a[o]).is(i) && n.push(a[o]) : 1 === a[o].nodeType && n.push(a[o]);
	...
	function(e, t) {
		...
		e.cleanData = function(t) {
			...
			for(var s, a, o = n.call(arguments, 1), r = 0, l = o.length; r < l; r++)
				for(s in o[r]) a = o[r][s], o[r].hasOwnProperty(s) && a !== t && (e.isPlainObject(a) ? i[s] = e.isPlainObject(i[s]) ? e.widget.extend({}, i[s], a) : e.widget.extend({}, a) : i[s] = a);
			return i
			...
			option: function(i, n) {
				...
				if("string" == typeof i)
					if(r = {}, s = i.split("."), i = s.shift(), s.length) {
						for(a = r[i] = e.widget.extend({}, this.options[i]), o = 0; o < s.length - 1; o++) a[s[o]] = a[s[o]] || {}, a = a[s[o]];
			...
			_trigger: function(t, i, n) {
				...
				if(n = n || {}, i = e.Event(i), i.type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(), i.target = this.element[0], a = i.originalEvent, a)
	...
	function(e, t) {
		...
		e.position = {
				...
				var a, p, m, g, v, y, b = e(t.of),
					...
					C = {};
				return y = s(b), b[0].preventDefault && (t.at = "left top"), p = y.width, m = y.height, g = y.offset, v = e.extend({}, g), e.each(["my", "at"], function() {
					var e, i, n = (t[this] || "").split(" ");
					1 === n.length && (n = c.test(n[0]) ? n.concat(["center"]) : d.test(n[0]) ? ["center"].concat(n) : ["center", "center"]), n[0] = c.test(n[0]) ? n[0] : "center", n[1] = d.test(n[1]) ? n[1] : "center", e = h.exec(n[0]), i = h.exec(n[1]), C[this] = [e ? e[0] : 0, i ? i[0] : 0], t[this] = [u.exec(n[0])[0], u.exec(n[1])[0]]
				}), 1 === x.length && (x[1] = x[0]), "right" === t.at[0] ? v.left += p : "center" === t.at[0] && (v.left += p / 2), "bottom" === t.at[1] ? v.top += m : "center" === t.at[1] && (v.top += m / 2), a = i(C.at, p, m), v.left += a[0], v.top += a[1], this.each(function() {
					var s, c, d = e(this),
						h = d.outerWidth(),
						u = d.outerHeight(),
						f = n(this, "marginLeft"),
					...
					"right" === t.my[0] ? S.left -= h : "center" === t.my[0] && (S.left -= h / 2), "bottom" === t.my[1] ? S.top -= u : "center" === t.my[1] && (S.top -= u / 2), S.left += D[0], S.top += D[1], e.support.offsetFractions || (S.left = l(S.left), S.top = l(S.top)), s = {
						marginLeft: f,
						marginTop: y
						...
						p < h && r(i + n) < p && (l.horizontal = "center"), m < u && r(s + a) < m && (l.vertical = "middle"), o(r(i), r(n)) > o(r(s), r(a)) ? l.important = "horizontal" : l.important = "vertical", t.using.call(this, e, l)
					}), d.offset(e.extend(S, {
						using: c
					}))
				})
			...
			function() {
				...
				t.appendChild(r), i = o || document.documentElement, i.insertBefore(t, i.firstChild), r.style.cssText = "position: absolute; left: 10.7432222px;", s = e(r).offset().left, e.support.offsetFractions = s > 10 && s < 11, t.innerHTML = "", i.removeChild(t)
			}()
	}(jQuery),
	function(e, t) {
		e.widget("ui.draggable", e.ui.mouse, {
			...
			drag: function(t, i) {
				...
				e.each(n.sortables, function() {
					...
					this.instance.positionAbs = n.positionAbs, this.instance.helperProportions = n.helperProportions, this.instance.offset.click = n.offset.click, this.instance._intersectsWith(this.instance.containerCache) && (a = !0, e.each(n.sortables, function() {
						return this.instance.positionAbs = n.positionAbs, this.instance.helperProportions = n.helperProportions, this.instance.offset.click = n.offset.click, this !== o && this.instance._intersectsWith(this.instance.containerCache) && e.contains(o.instance.element[0], this.instance.element[0]) && (a = !1), a
			...
			drag: function(t, i) {
				...
				for(h = p.snapElements.length - 1; h >= 0; h--) r = p.snapElements[h].left, l = r + p.snapElements[h].width, c = p.snapElements[h].top, d = c + p.snapElements[h].height, r - m < g && g < l + m && c - m < y && y < d + m || r - m < g && g < l + m && c - m < b && b < d + m || r - m < v && v < l + m && c - m < y && y < d + m || r - m < v && v < l + m && c - m < b && b < d + m ? ("inner" !== f.snapMode && (n = Math.abs(c - b) <= m, s = Math.abs(d - y) <= m, a = Math.abs(r - v) <= m, o = Math.abs(l - g) <= m, n && (i.position.top = p._convertPositionTo("relative", {
	...
	function(e, t) {
		...
		e.widget("ui.droppable", {
			...
			switch(n) {
				...
				case "pointer":
					return s = (e.positionAbs || e.position.absolute).left + (e.clickOffset || e.offset.click).left, a = (e.positionAbs || e.position.absolute).top + (e.clickOffset || e.offset.click).top, i(a, u, t.proportions.height) && i(s, d, t.proportions.width);
				case "touch":
			...
			prepareOffsets: function(t, i) {
				...
				e: for(n = 0; n < a.length; n++)
					if(!(a[n].options.disabled || t && !a[n].accept.call(a[n].element[0], t.currentItem || t.element))) {
						for(s = 0; s < r.length; s++)
							if(r[s] === a[n].element[0]) {
								a[n].proportions.height = 0;
								continue e
							}
						a[n].visible = "none" !== a[n].element.css("display"), a[n].visible && ("mousedown" === o && a[n]._activate.call(a[n], i), a[n].offset = a[n].element.offset(), a[n].proportions = {
		...
		e.widget("ui.resizable", e.ui.mouse, {
			...
			_create: function() {
				...
				if(this.element.addClass("ui-resizable"), e.extend(this, {
					...
					for("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), t = this.handles.split(","), this.handles = {}, i = 0; i < t.length; i++) n = e.trim(t[i]), a = "ui-resizable-" + n, s = e("<div class='ui-resizable-handle " + a + "'></div>"), s.css({
						zIndex: r.zIndex
					}), "se" === n && s.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[n] = ".ui-resizable-" + n, this.element.append(s);
				this._renderAxis = function(t) {
					var i, n, s, a;
					t = t || this.element;
					for(i in this.handles) this.handles[i].constructor === String && (this.handles[i] = e(this.handles[i], this.element).show()), this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i) && (n = e(this.handles[i], this.element), a = /sw|ne|nw|se|n|s/.test(i) ? n.outerHeight() : n.outerWidth(), s = ["padding", /ne|nw|n/.test(i) ? "Top" : /se|sw|s/.test(i) ? "Bottom" : /^e$/.test(i) ? "Right" : "Left"].join(""), t.css(s, a), this._proportionallyResize()), e(this.handles[i]).length
			...
			_mouseStart: function(t) {
				...
				return this.resizing = !0, /absolute/.test(l.css("position")) ? l.css({
					...
					top: r.top,
					left: r.left
				}), this._renderProxy(), n = i(this.helper.css("left")), s = i(this.helper.css("top")), o.containment && (n += e(o.containment).scrollLeft() || 0, s += e(o.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
					left: n,
					top: s
					...
					left: t.pageX,
					top: t.pageY
				}, this.aspectRatio = "number" == typeof o.aspectRatio ? o.aspectRatio : this.originalSize.width / this.originalSize.height || 1, a = e(".ui-resizable-" + this.axis).css("cursor"), e("body").css("cursor", "auto" === a ? this.axis + "-resize" : a), l.addClass("ui-resizable-resizing"), this._propagate("start", t), !0
			},
			...
			_updateVirtualBoundaries: function(e) {
				...
				}, (this._aspectRatio || e) && (t = o.minHeight * this.aspectRatio, s = o.minWidth / this.aspectRatio, i = o.maxHeight * this.aspectRatio, a = o.maxWidth / this.aspectRatio, t > o.minWidth && (o.minWidth = t), s > o.minHeight && (o.minHeight = s), i < o.maxWidth && (o.maxWidth = i), a < o.maxHeight && (o.maxHeight = a)), this._vBoundaries = o
			},
			...
			_respectSize: function(e) {
				var t = this._vBoundaries,
					...
					d = /sw|nw|w/.test(i),
					h = /nw|ne|n/.test(i);
				return o && (e.width = t.minWidth), r && (e.height = t.minHeight), s && (e.width = t.maxWidth), a && (e.height = t.maxHeight), o && d && (e.left = l - t.minWidth), s && d && (e.left = l - t.maxWidth), r && h && (e.top = c - t.minHeight), a && h && (e.top = c - t.maxHeight), e.width || e.height || e.left || !e.top ? !e.width && !e.height && !e.top && e.left && (e.left = null) : e.top = null, e
			},
			...
			resize: function() {
				...
				i.grid = r, g && (u += l), v && (p += c), f && (u -= l), m && (p -= c), /^(se|s|e)$/.test(o) ? (t.size.width = u, t.size.height = p) : /^(ne)$/.test(o) ? (t.size.width = u, t.size.height = p, t.position.top = a.top - h) : /^(sw)$/.test(o) ? (t.size.width = u, t.size.height = p, t.position.left = a.left - d) : (t.size.width = u, t.size.height = p, t.position.top = a.top - h, t.position.left = a.left - d)
			}
		})
	}(jQuery),
	function(e, t) {
			...
			_mouseDrag: function(t) {
				if(this.dragged = !0, !this.options.disabled) {
					var i, n = this,
						...
						l = t.pageY;
					return a > r && (i = r,
						r = a, a = i), o > l && (i = l, l = o, o = i), this.helper.css({
						left: a,
						top: o,
						width: r - a,
						height: l - o
		...
		e.widget("ui.sortable", e.ui.mouse, {
			...
			_mouseCapture: function(t, i) {
				...
				return !this.reverting && (!this.options.disabled && "static" !== this.options.type && (this._refreshItems(t), e(t.target).parents().each(function() {
					if(e.data(this, a.widgetName + "-item") === a) return n = e(this), !1
			...
			_getItemsAsjQuery: function(t) {
				...
				if(l && t)
					for(i = l.length - 1; i >= 0; i--)
						for(s = e(l[i]), n = s.length - 1; n >= 0; n--) a = e.data(s[n], this.widgetFullName), a && a !== this && !a.options.disabled && r.push([e.isFunction(a.options.items) ? a.options.items.call(a.element) : e(a.options.items, a.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), a]);
			...
			_refreshItems: function(t) {
				...
				if(u && this.ready)
					for(i = u.length - 1; i >= 0; i--)
						for(s = e(u[i]), n = s.length - 1; n >= 0; n--) a = e.data(s[n], this.widgetFullName), a && a !== this && !a.options.disabled && (h.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, {
							item: this.currentItem
						}) : e(a.options.items, a.element), a]), this.containers.push(a));
				for(i = h.length - 1; i >= 0; i--)
					for(o = h[i][1], r = h[i][0], n = 0, c = r.length; n < c; n++) l = e(r[n]), l.data(this.widgetName + "-item", o), d.push({
						item: l,
						instance: o,
						width: 0,
						height: 0,
			...
			_contactContainers: function(t) {
				...
				if(h)
					if(1 === this.containers.length) this.containers[u]._trigger("over", t, this._uiHash(this)), this.containers[u].containerCache.over = 1;
					else {
	...
	function(e, t) {
		...
		n.height = n.paddingTop = n.paddingBottom = n.borderTopWidth = n.borderBottomWidth = "hide", s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth = "show", e.widget("ui.accordion", {
			...
			_refresh: function() {
				...
				this.active = this._findActive(n.active).addClass("ui-accordion-header-active ui-state-active ui-corner-top").removeClass("ui-corner-all"), this.active.next().addClass("ui-accordion-content-active").show(), this.headers.attr("role", "tab").each(function(t) {
					var i = e(this),
						...
						s = i.next(),
						a = s.attr("id");
					n || (n = o + "-header-" + t, i.attr("id", n)), a || (a = o + "-panel-" + t, s.attr("id", a)), i.attr("aria-controls", a), s.attr("aria-labelledby", n)
					...
					"aria-expanded": "true",
					"aria-hidden": "false"
				}) : this.headers.eq(0).attr("tabIndex", 0), this._createIcons(), this._setupEvents(n.event), "fill" === s ? (t = a.height(), this.element.siblings(":visible").each(function() {
					var i = e(this),
						n = i.css("position");
			...
			_eventHandler: function(t) {
				...
				t.preventDefault(), a && !i.collapsible || this._trigger("beforeActivate", t, c) === !1 || (i.active = !o && this.headers.index(s), this.active = a ? e() : s, this._toggle(c), n.removeClass("ui-accordion-header-active ui-state-active"), i.icons && n.children(".ui-accordion-header-icon").removeClass(i.icons.activeHeader).addClass(i.icons.header), a || (s.removeClass("ui-corner-all").addClass("ui-accordion-header-active ui-state-active ui-corner-top"), i.icons && s.children(".ui-accordion-header-icon").removeClass(i.icons.header).addClass(i.icons.activeHeader), s.next().addClass("ui-accordion-content-active")))
			},
			_toggle: function(t) {
				var i = t.newPanel,
					n = this.prevShow.length ? this.prevShow : t.oldPanel;
				this.prevShow.add(this.prevHide).stop(!0, !0), this.prevShow = i, this.prevHide = n,
					this.options.animate ? this._animate(i, n, t) : (n.hide(), i.show(), this._toggleComplete(t)), n.attr({
						"aria-expanded": "false",
						"aria-hidden": "true"
			...
			_animate: function(e, t, i) {
				...
				return "number" == typeof u && (r = u), "string" == typeof u && (o = u), o = o || u.easing || h.easing, r = r || u.duration || h.duration, t.length ? e.length ? (a = e.show().outerHeight(), t.animate(n, {
					duration: r,
					easing: o,
					step: function(e, t) {
						t.now = Math.round(e)
	...
	function(e, t) {
		...
		e.widget("ui.button", {
			...
			_destroy: function() {
				this.element.removeClass("ui-helper-hidden-accessible"), this.buttonElement.removeClass(o + " " + r + " " + l).removeAttr("role").removeAttr("aria-pressed").html(this.buttonElement.find(".ui-button-text").html()), this.hasTitle || this.buttonElement.removeAttr("title")
			},
			_setOption: function(e, t) {
	...
	function(e, t) {
		...
		e.extend(i.prototype, {
			...
			_updateDatepicker: function(t) {
				...
				var i, n = this._getNumberOfMonths(t),
					s = n[1],
					o = 17;
				t.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), s > 1 && t.dpDiv.addClass("ui-datepicker-multi-" + s).css("width", o * s + "em"), t.dpDiv[(1 !== n[0] || 1 !== n[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), t.dpDiv[(this._get(t, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), t === e.datepicker._curInst && e.datepicker._datepickerShowing && t.input && t.input.is(":visible") && !t.input.is(":disabled") && t.input[0] !== document.activeElement && t.input.focus(), t.yearshtml && (i = t.yearshtml, setTimeout(function() {
			...
			_hideDatepicker: function(t) {
				...
				!r || t && r !== e.data(t, o) || this._datepickerShowing && (i = this._get(r, "showAnim"), n = this._get(r, "duration"), s = function() {
					...
					}, e.effects && (e.effects.effect[i] || e.effects[i]) ? r.dpDiv.hide(i, e.datepicker._get(r, "showOptions"), n, s) : r.dpDiv["slideDown" === i ? "slideUp" : "fadeIn" === i ? "fadeOut" : "hide"](i ? n : null, s), i || s(), this._datepickerShowing = !1, a = this._get(r, "onClose"), a && a.apply(r.input ? r.input[0] : null, [r.input ? r.input.val() : "", r]),
			...
			parseDate: function(t, i, n) {
				...
				if(m === -1 ? m = (new Date).getFullYear() : m < 100 && (m += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (m <= d ? 0 : -100)), y > -1)
					for(g = 1, v = y;;) {
			...
			_attachHandlers: function(t) {
				...
				t.dpDiv.find("[data-handler]").map(function() {
					var t = {
						...
						selectDay: function() {
							return window["DP_jQuery_" + r].datepicker._selectDay(n, +this.getAttribute("data-month"), +this.getAttribute("data-year"), this), !1
						},
						selectMonth: function() {
							return window["DP_jQuery_" + r].datepicker._selectMonthYear(n, this, "M"), !1
						},
						selectYear: function() {
							return window["DP_jQuery_" + r].datepicker._selectMonthYear(n, this, "Y"), !1
						}
					};
			...
			_generateHTML: function(e) {
				var t, i, n, s, a, o, r, l, c, d, h, u, p, f, m, g, v, y, b, w, _, x, C, k, T, S, D, E, I, P, M, j, N, A, O, z, $, H, L, W = new Date,
					...
					ee = e.drawYear;
				if(Z < 0 && (Z += 12, ee--), J)
					for(t = this._daylightSavingAdjust(new Date(J.getFullYear(), J.getMonth() - Y[0] * Y[1] + 1, J.getDate())), t = Q && t < Q ? Q : t; this._daylightSavingAdjust(new Date(ee, Z, 1)) > t;) Z--, Z < 0 && (Z = 11, ee--);
				for(e.drawMonth = Z, e.drawYear = ee, i = this._get(e, "prevText"), i = V ? this.formatDate(i, this._daylightSavingAdjust(new Date(ee, Z - G, 1)), this._getFormatConfig(e)) : i, n = this._canAdjustMonth(e, -1, ee, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (F ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (F ? "e" : "w") + "'>" + i + "</span></a>", s = this._get(e, "nextText"), s = V ? this.formatDate(s, this._daylightSavingAdjust(new Date(ee, Z + G, 1)), this._getFormatConfig(e)) : s, a = this._canAdjustMonth(e, 1, ee, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (F ? "w" : "e") + "'>" + s + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (F ? "w" : "e") + "'>" + s + "</span></a>", o = this._get(e, "currentText"), r = this._get(e, "gotoCurrent") && e.currentDay ? K : R, o = V ? this.formatDate(o, r, this._getFormatConfig(e)) : o, l = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", c = B ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (F ? l : "") + (this._isInRange(e, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>" : "") + (F ? "" : l) + "</div>" : "", d = parseInt(this._get(e, "firstDay"), 10), d = isNaN(d) ? 0 : d, h = this._get(e, "showWeek"), u = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), f = this._get(e, "monthNames"), m = this._get(e, "monthNamesShort"), g = this._get(e, "beforeShowDay"), v = this._get(e, "showOtherMonths"), y = this._get(e, "selectOtherMonths"), b = this._getDefaultDate(e), w = "", _, x = 0; x < Y[0]; x++) {
					for(C = "", this.maxRows = 4, k = 0; k < Y[1]; k++) {
						...
						Z++, Z > 11 && (Z = 0, ee++), D += "</tbody></table>" + (X ? "</div>" + (Y[0] > 0 && k === Y[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), C += D
					}
					w += C
				}
			...
			_isInRange: function(e, t) {
				...
				return l && (i = l.split(":"), n = (new Date).getFullYear(), o = parseInt(i[0], 10), r = parseInt(i[1], 10), i[0].match(/[+\-].*/) && (o += n), i[1].match(/[+\-].*/) && (r += n)), (!s || t.getTime() >= s.getTime()) && (!a || t.getTime() <= a.getTime()) && (!o || t.getFullYear() >= o) && (!r || t.getFullYear() <= r)
			},
		...
		}, e.datepicker = new i, e.datepicker.initialized = !1, e.datepicker.uuid = (new Date).getTime(), e.datepicker.version = "1.10.1", window["DP_jQuery_" + r] = e
	}(jQuery),
	function(e, t) {
		var i = {
				buttons: !0,
		...
		e.widget("ui.dialog", {
			...
			_setOptions: function(t) {
				...
				e.each(t, function(e, t) {
					s._setOption(e, t), e in i && (a = !0), e in n && (o[e] = t)
			...
			_keydown: function(t) {
				...
				switch(t.keyCode) {
					...
					case e.ui.keyCode.ESCAPE:
						...
						break;
					default:
						l = !1, s = this.previousFilter || "", a = String.fromCharCode(t.keyCode), o = !1, clearTimeout(this.filterTimer), a === s ? o = !0 : a = s + a, r = new RegExp("^" + i(a), "i"), n = this.activeMenu.children(".ui-menu-item").filter(function() {
							return r.test(e(this).children("a").text())
						}), n = o && n.index(this.active.next()) !== -1 ? this.active.nextAll(".ui-menu-item") : n, n.length || (a = String.fromCharCode(t.keyCode), r = new RegExp("^" + i(a), "i"), n = this.activeMenu.children(".ui-menu-item").filter(function() {
							return r.test(e(this).children("a").text())
	...
	function(e, t) {
		e.widget("ui.progressbar", {
			...
			_constrainedValue: function(e) {
				return e === t && (e = this.options.value), this.indeterminate = e === !1, "number" != typeof e && (e = 0), !this.indeterminate && Math.min(this.options.max, Math.max(this.min, e))
			},
			_setOptions: function(e) {
				var t = e.value;
		...
		e.widget("ui.slider", e.ui.mouse, {
			...
			_refreshValue: function() {
				...
				this.options.values && this.options.values.length ? this.handles.each(function(n) {
					i = (l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100, d["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", e(this).stop(1, 1)[c ? "animate" : "css"](d, r.animate), l.options.range === !0 && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[c ? "animate" : "css"]({
						left: i + "%"
		...
		e.widget("ui.tabs", {
			...
			_tabKeydown: function(t) {
				...
				if(!this._handlePageNav(t)) {
					switch(t.keyCode) {
						...
						case e.ui.keyCode.ENTER:
							return t.preventDefault(), clearTimeout(this.activating), this._activate(n !== this.options.active && n), void 0;
						default:
							return
					}
			...
			_processTabs: function() {
				...
				this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist"), this.tabs = this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({
					...
					n(s) ? (a = s.hash, o = t.element.find(t._sanitizeSelector(a))) : (r = t._tabId(c), a = "#" + r, o = t.element.find(a), o.length || (o = t._createPanel(r), o.insertAfter(t.panels[i - 1] || t.tablist)), o.attr("aria-live", "polite")), o.length && (t.panels = t.panels.add(o)), d && c.data("ui-tabs-aria-controls", d), c.attr({
	...
	function(e) {
		...
		e.widget("ui.tooltip", {
			...
			_open: function(i, n, s) {
				...
				if(s) {
					...
					n.is("[title]") && (i && "mouseover" === i.type ? n.attr("title", "") : n.removeAttr("title")), o = this._tooltip(n), t(n, o.attr("id")), o.find(".ui-tooltip-content").html(s), this.options.track && i && /^mouse/.test(i.type) ? (this._on(this.document, {
						mousemove: a
					}), a(i)) : o.position(e.extend({ of: n
		...
		e.effects = {
				...
				p.style.cssText = "background-color:rgba(1,1,1,.5)", u.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(d, function(e, t) {
					...
					parse: function(s, o, r, l) {
						...
						var h = this,
							u = e.type(s),
							p = this._rgba = [];
						return o !== t && (s = [s, o, r, l], u = "array"), "string" === u ? this.parse(n(s) || a._default) : "array" === u ? (f(d.rgba.props, function(e, t) {
							p[t.idx] = i(s[t.idx], t)
					...
					var t, i, n = e[0] / 255,
						...
						d = r + l,
						h = .5 * d;
					return t = l === r ? 0 : n === r ? 60 * (s - a) / c + 360 : s === r ? 60 * (a - n) / c + 120 : 60 * (n - s) / c + 240, i = 0 === c ? 0 : h <= .5 ? c / d : c / (2 - d), [Math.round(t) % 360, i, h, null == o ? 1 : o]
			...
			function() {
				...
				function n(t, i) {
					var n, s, o = {};
					for(n in i) s = i[n], t[n] !== s && !a[n] && (e.fx.step[n] || !isNaN(parseFloat(s))) && (o[n] = s);
					return o
				}
			...
			function() {
				...
				e.extend(e.effects, {
					...
					createWrapper: function(t) {
						...
						return t.wrap(n), (t[0] === a || e.contains(t[0], a)) && e(a).focus(), n = t.parent(), "static" === t.css("position") ? (n.css({
							position: "relative"
						}), t.css({
							position: "relative"
						})) : (e.extend(i, {
	...
	function(e, t) {
		...
		e.effects.effect.blind = function(t, s) {
			...
			l.parent().is(".ui-effects-wrapper") ? e.effects.save(l.parent(), c) : e.effects.save(l, c), l.show(), a = e.effects.createWrapper(l).css({
				overflow: "hidden"
			}), o = a[p](), r = parseFloat(a.css(f)) || 0, g[p] = v ? o : 0, m || (l.css(u ? "bottom" : "right", 0).css(u ? "top" : "left", "auto").css({
				position: "absolute"
	...
	function(e, t) {
		e.effects.effect.bounce = function(t, i) {
			...
			for((d || c) && r.push("opacity"), e.effects.save(o, r), o.show(), e.effects.createWrapper(o), u || (u = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), d && (a = {
					opacity: 1
				}, a[v] = 0, o.css("opacity", 0).css(v, y ? 2 * -u : 2 * u).animate(a, m, g)), c && (u /= Math.pow(2, p - 1)), a = {}, a[v] = 0, n = 0; n < p; n++) s = {}, s[v] = (y ? "-=" : "+=") + u, o.animate(s, m, g).animate(a, m, g), u = c ? 2 * u : u / 2;
			c && (s = {
				opacity: 0
			}, s[v] = (y ? "-=" : "+=") + u, o.animate(s, m, g)), o.queue(function() {
	...
	function(e, t) {
		e.effects.effect.clip = function(t, i) {
			...
			e.effects.save(o, r), o.show(), n = e.effects.createWrapper(o).css({
				overflow: "hidden"
			}), s = "IMG" === o[0].tagName ? n : o, a = s[u](), c && (s.css(u, 0), s.css(p, a / 2)), f[u] = c ? a : 0, f[p] = c ? 0 : a / 2, s.animate(f, {
				queue: !1,
				duration: t.duration,
				easing: t.easing,
				complete: function() {
	...
	function(e, t) {
		e.effects.effect.drop = function(t, i) {
			...
			e.effects.save(s, a), s.show(), e.effects.createWrapper(s), n = t.distance || s["top" === c ? "outerHeight" : "outerWidth"](!0) / 2, r && s.css("opacity", 0).css(c, "pos" === d ? -n : n), h[c] = (r ? "pos" === d ? "+=" : "-=" : "pos" === d ? "-=" : "+=") + n, s.animate(h, {
				queue: !1,
				duration: t.duration,
				easing: t.easing,
				complete: function() {
					"hide" === o && s.hide(), e.effects.restore(s, a), e.effects.removeWrapper(s), i()
				}
			})
		}
	}(jQuery),
	function(e, t) {
		e.effects.effect.explode = function(t, i) {
			...
			var a, o, r, l, c, d, h = t.pieces ? Math.round(Math.sqrt(t.pieces)) : 3,
				...
				b = [];
			for(a = 0; a < h; a++)
				for(l = g.top + a * y, d = a - (h - 1) / 2, o = 0; o < u; o++) r = g.left + o * v, c = o - (u - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
					position: "absolute",
					visibility: "visible",
					left: -o * v,
					top: -a * y
	...
	function(e, t) {
		e.effects.effect.highlight = function(t, i) {
			...
			"hide" === a && (o.opacity = 0), e.effects.save(n, s), n.show().css({
	...
	function(e, t) {
		e.effects.effect.puff = function(t, i) {
			...
			s.effect = "size", s.queue = !1, s.complete = i, "effect" !== a && (s.origin = l || ["middle", "center"], s.restore = !0), s.from = t.from || ("show" === a ? {
				height: 0,
				width: 0,
				outerHeight: 0,
				outerWidth: 0
			...
			}, "toggle" === t.mode && "show" === p ? (o.from = t.to || b, o.to = t.from || n) : (o.from = t.from || ("show" === p ? b : n), o.to = t.to || ("hide" === p ? b : n)), a = {
				from: {
			...
			}, "box" !== m && "both" !== m || (a.from.y !== a.to.y && (y = y.concat(h), o.from = e.effects.setTransition(o, h, a.from.y, o.from), o.to = e.effects.setTransition(o, h, a.to.y, o.to)), a.from.x !== a.to.x && (y = y.concat(u), o.from = e.effects.setTransition(o, u, a.from.x, o.from), o.to = e.effects.setTransition(o, u, a.to.x, o.to))), ("content" === m || "both" === m) && a.from.y !== a.to.y && (y = y.concat(d).concat(c), o.from = e.effects.setTransition(o, d, a.from.y, o.from), o.to = e.effects.setTransition(o, d, a.to.y, o.to)), e.effects.save(o, y), o.show(), e.effects.createWrapper(o), o.css("overflow", "hidden").css(o.from), g && (s = e.effects.getBaseline(g, n), o.from.top = (n.outerHeight - o.outerHeight()) * s.y,
				o.from.left = (n.outerWidth - o.outerWidth()) * s.x, o.to.top = (n.outerHeight - o.to.outerHeight) * s.y, o.to.left = (n.outerWidth - o.to.outerWidth) * s.x), o.css(o.from), "content" !== m && "both" !== m || (h = h.concat(["marginTop", "marginBottom"]).concat(d), u = u.concat(["marginLeft", "marginRight"]), c = r.concat(h).concat(u), o.find("*[width]").each(function() {
				var i = e(this),
					n = {
						height: i.height(),
						width: i.width(),
	...
	function(e, t) {
		e.effects.effect.shake = function(t, i) {
			...
			s.animate(m, h, t.easing).animate(f, h / 2, t.easing).queue(function() {
				"hide" === o && s.hide(), e.effects.restore(s, a), e.effects.removeWrapper(s), i()
			}), y > 1 && v.splice.apply(v, [1, 0].concat(v.splice(y, d + 1))), s.dequeue()
		}
	}(jQuery),
	function(e, t) {
		e.effects.effect.slide = function(t, i) {
			var n, s = e(this),
				...
				d = "up" === l || "left" === l,
				h = {};
			e.effects.save(s, a), s.show(), n = t.distance || s["top" === c ? "outerHeight" : "outerWidth"](!0), e.effects.createWrapper(s).css({
				overflow: "hidden"
			}), r && s.css(c, d ? isNaN(n) ? "-" + n : -n : n), h[c] = (r ? d ? "+=" : "-=" : d ? "-=" : "+=") + n, s.animate(h, {
				queue: !1,
				duration: t.duration,
				easing: t.easing,
				complete: function() {
	...
	function(e) {
		...
		e.fn.scrollUp = function(t) {
			...
			switch(d = h.scrollTrigger ? e(h.scrollTrigger) : e("<a/>", {
				...
				case "fade":
					s = "fadeIn", a = "fadeOut", o = h.animationSpeed;
					break;
				case "slide":
					s = "slideDown", a = "slideUp", o = h.animationSpeed;
					break;
				default:
					s = "show", a = "hide", o = 0
			}
			r = "top" === h.scrollFrom ? h.scrollDistance : e(i).height() - e(t).height() - h.scrollDistance, l = e(t).scroll(function() {
				e(t).scrollTop() > r ? u || (d[s](o), u = !0) : u && (d[a](o), u = !1)
			}), h.scrollTarget ? "number" == typeof h.scrollTarget ? c = h.scrollTarget : "string" == typeof h.scrollTarget && (c = Math.floor(e(h.scrollTarget).offset().top)) : c = 0, d.click(function(t) {
			...
			e.removeData(i.body, "scrollUp"), e("#" + e.fn.scrollUp.settings.scrollName).remove(), e("#" + e.fn.scrollUp.settings.scrollName + "-active").remove(), e.fn.jquery.split(".")[1] >= 7 ? e(t).off("scroll", n) : e(t).unbind("scroll", n)
...
$(function(e) {
	var t;
	e(".con-filter-div .swiper-scroll").css("max-height", e(window).height()), e(".swiper-scroll").hasClass("swiper-scroll") && swiper_scroll(), e(".ect-header-banner i.icon-guanbi1").click(function() {
	...
	n.bind("focus", function() {
		s.removeClass("active"), "" != e(this).val() && e(this).siblings(".j-is-null").addClass("active")
	}), n.bind("input", function() {
		"" == e(this).val() ? e(this).siblings(".j-is-null").removeClass("active") : e(this).siblings(".j-is-null").addClass("active")
	}), s.click(function() {
		e(this).siblings(".j-input-text").val(""), e(this).siblings(".j-input-text").focus()
	}), a.click(function() {
		input_text_atr = e(this).siblings(".input-text").find(".j-input-text"), "password" == input_text_atr.attr("type") && e(this).hasClass("disabled") ? input_text_atr.attr("type", "text") : input_text_atr.attr("type", "password"), input_text_atr.focus(), e(this).toggleClass("disabled")
	});
	...
	e(".j-a-sequence").click(function() {
		var t = e(this).find("i").attr("data"),
			i = o.length,
			n = t;
		t++, t >= i && (t = 0), e(this).find(".iconfont").removeClass(o[n]).addClass(o[t]), e(this).find(".iconfont").attr("data", t), e(".j-product-list").removeClass(r[n]).addClass(r[t]), e(".j-product-list").attr("data", t)
	...
	}), e(".j-sub-menu").hide(), e(".j-get-city-one, .select-two").on("click", "a.j-menu-select", function() {
		e(this).next(".j-sub-menu").slideToggle().siblings(".j-sub-menu").slideUp(), e(this).toggleClass("active").siblings().removeClass("active");
		new Swiper(".swiper-scroll", {
			scrollbar: !1,
			direction: "vertical",
			slidesPerView: "auto",
	...
	e(".j-get-limit .ect-select").not(".j-checkbox-all").click(function() {
		get_text = e(this).parents(".j-get-limit"), s_t_em_value = get_text.prev(".select-title").find(".t-jiantou em"), checked = e(this).find("label").hasClass("active"), l = e(this).parents(".j-get-limit").attr("data-istrue");
		var t = "",
			n = 0,
			s = "",
			a = get_text.prev(".j-menu-select").find(".j-t-jiantou");
		a.addClass("active"), get_text.find(".j-checkbox-all label").hasClass("active") && get_text.find(".j-checkbox-all label").removeClass("active"), "true" == l && e(this).find("label").toggleClass("active"), checked && (e(this).find("label").removeClass("active"), e(this).parents(".j-get-limit").attr("data-istrue", "true")), "false" == l && d_messages("筛选最多不能超过5个"), s_get_label = get_text.find("label.active"), n = s_get_label.length, n <= 0 && (a.removeClass("active"), e(".j-checkbox-all label").addClass("active"), t = e(this).siblings(".j-checkbox-all").find("label").text() + "、"), n >= 5 ? e(this).parents(".j-get-limit").attr("data-istrue", "false") : e(this).parents(".j-get-limit").attr("data-istrue", "true"), s_get_label.each(function() {
			t += e(this).text() + "、", e(this).parents("ul").hasClass("brand") && (s += e(this).parent("li").attr("data-brand") + ",")
		}), s_t_em_value.text(t.substring(0, t.length - 1)), "" != s && (s = s.substring(0, s.length - 1), e("input[name=brand]").val(s));
		var o = {};
		...
		if(e(this).parent().find("label").each(function() {
			...
			s && (s = s.substring(0, s.length - 1)), e("input[name=filter_attr]").val(s)
		}
		e("input[name=brand]").val(0)
	}), e(".j-filter-reset").click(function() {
		e(".con-filter-div label").removeClass("active"), e(".j-checkbox-all label").addClass("active"), e(".j-radio-switching").removeClass("active"), e(".j-menu-select .j-t-jiantou").removeClass("active"), e(".j-menu-select .j-t-jiantou em").text("全部"), e(".j-filter-city span.text-all-span").css("color", "#555"), e(".j-filter-city span.text-all-span").text("请选择"), e("#slider-range a:first").css("left", 0), e("#slider-range a:last").css("left", "100%"), e(".ui-widget-header").css({
			left: 0,
			width: "100%"
		});
		var t = e(".price-range-label").attr("data-min") + "~" + e(".price-range-label").attr("data-max");
		e("#slider-range-amount").text(t), e(this).parents(".j-get-limit").attr("data-istrue", !0), l = !0, e(".j-checkbox-all label").each(function() {
			e(this).parents("ul").prev().find("span").removeClass("active"), e(this).parents("ul").prev().find("span em").text(e(this).text())
		}), e("input[name=brand]").val(0), e("input[name=filter_attr]").val(0), e("input[name=isself]").val(0), e("input[name=price_min]").val(e(".price-range-label").attr("data-min")), e("input[name=price_max]").val(e(".price-range-label").attr("data-max")), e("input[name=isself]").val(0)
		...
		if(e(this).parents(".ect-select").hasClass("j-flowcoupon-select-disab")) d_messages("同商家只能选择一个", 2);
			...
			t.each(function() {
				if(!e(this).hasClass("active")) return is_select_all = !1, !1
		...
		if(get_tjiantou = e(this).parent(".j-get-one").prev(".select-title").find(".t-jiantou"), e(this).find("label").addClass("active").parent(".ect-select").siblings().find("label").removeClass("active"), get_tjiantou.find("em").text(e(this).find("label").text()), e(this).hasClass("j-checkbox-all") ? get_tjiantou.removeClass("active") : get_tjiantou.addClass("active"), e(this).parents("show-goods-attr")) {
			...
			i = parseInt(i) ? parseInt(i) : 1, t = t + i + "个", e(".j-goods-attr").find(".t-goods1").text(t)
		}
	}), e(".j-flow-site .ect-select").click(function() {
		site_h4_text = e(this).find("h4").text(), e(this).parents(".j-goods-site-li").find(".t-goods1 span").text(site_h4_text)
		...
		city_span = e(".j-filter-city span.text-all-span"), city_txt = e(".j-city-left li.active").text() + " " + e(this).parents(".j-sub-menu").prev(".j-menu-select").find("label").text() + " " + e(this).find("label").text(), e(".j-get-city-one").find(".ect-select label").removeClass("active"), e(this).find("label").addClass("active"), city_span.text(city_txt), e(".j-filter-city span.text-all-span").hasClass("j-city-scolor") && e(".j-filter-city span.text-all-span").css("color", "#ec5151"), e("body").removeClass("show-city-div"), e("html,body").animate({
			scrollTop: t
		}, 0)
	}), e(".j-get-depot-one .ect-select").click(function() {
		city_span = e(".j-filter-depot span.text-all-span"), city_txt = e(this).find("label").text(), e(".j-get-depot-one").find(".ect-select label").removeClass("active"), e(this).find("label").addClass("active"), city_span.text(city_txt), e(".j-filter-depot span.text-all-span").hasClass("j-city-scolor") && e(".j-filter-depot span.text-all-span").css("color", "#ec5151"), e("body").removeClass("show-depot-div"), e("html,body").animate({
			scrollTop: t
		}, 0)
	}), e("#sidebar").on("click", "li", function() {
		e("#sidebar li").removeClass("active"), e(this).addClass("active")
	}), e(".s-g-list-con .j-get-one .ect-select").click(function() {
		dist_span = e(this).find("label>dd").html(), t_goods1 = e(this).parents(".j-show-get-val").find(".t-goods1"), t_goods1.html(dist_span)
	}), e(".flow-receipt .r-btn-submit").click(function() {
		if(e("body").hasClass("show-receipt-div")) return document.removeEventListener("touchmove", handler, !1), e("body").removeClass("show-receipt-div"), f_r_title = e(".flow-receipt-title .j-input-text").val(), f_r_cont = e(".flow-receipt-cont .active").text(), f_r_type = e(".flow-receipt-cont .active").attr("data-type"), "" == f_r_title && (f_r_title = "个人"), receipt_title = e(this).parents(".j-f-c-receipt").find(".receipt-title"), receipt_name = e(this).parents(".j-f-c-receipt").find(".receipt-name"), receipt_title.text(f_r_title), receipt_name.text(f_r_cont), f_r_title && "不开发票" != f_r_cont ? (e.get("index.php?r=flow/index/change_needinv", {
			need_inv: 1,
			inv_type: "",
			inv_payee: f_r_title,
			inv_content: f_r_cont
		}, function(t) {
			e("#ECS_ORDERTOTAL").html(t.content), e("#amount").html(t.amount)
		}, "json"), e("#inv_type").val(f_r_type), e("#ECS_NEEDINV").val(1)) : e("#ECS_NEEDINV").val(0), e("#ECS_INVPAYEE").val(f_r_title), e("#ECS_INVCONTENT").val(f_r_cont), !1
	}), e(".flow-coupon .c-btn-submit").click(function() {
		if(e("body").hasClass("show-coupon-div")) {
			if(document.removeEventListener("touchmove", handler, !1), e("body").removeClass("show-coupon-div"), coupon_list = e(this).parents(".flow-coupon").find(".ect-select label.active"), coupon_text = e(this).parents(".j-f-c-s-coupon").find(".t-goods1 .coupon-text"), coupon_price = e(this).parents(".j-f-c-s-coupon").find(".t-goods1 .coupon-price"), coupon_list.length > 1) return d_messages("一次只能使用一张红包"), !1;
			...
			return e.get("index.php?r=flow/index/change_bonus", {
				...
				} else t.bonus_id && e("#ECS_BONUS").val(t.bonus_id), t.content && e("#ECS_ORDERTOTAL").html(t.content), void 0 != t.amount && e("#amount").html(t.amount)
			}, "json"), coupon_list.length <= 0 ? (coupon_text.text("不使用红包"), coupon_price.text("")) : (coupon_text.text("优惠金额"), coupon_price.text("¥" + parseInt(coupon_list.attr("data-money")) + ".00")), !1
		}
	}), e(".flow-coupon .cou-btn-submit").click(function() {
		if(e("body").hasClass("show-coupon-div-1")) {
			if(document.removeEventListener("touchmove", handler, !1), e("body").removeClass("show-coupon-div-1"), coupon_list = e(this).parents(".flow-coupon").find(".ect-select label.active"), coupon_text = e(this).parents(".j-f-c-s-coupon-1").find(".t-goods1 .coupon-text"), coupon_price = e(this).parents(".j-f-c-s-coupon-1").find(".t-goods1 .coupon-price"), coupon_list.length > 1) return d_messages("一次只能使用一张优惠券"), !1;
			...
			return e.get("index.php?r=flow/index/change_coupont", {
				...
				} else t.cou_id && e("#ECS_COUPONT").val(t.cou_id), t.content && e("#ECS_ORDERTOTAL").html(t.content), void 0 != t.amount && e("#amount").html(t.amount)
			}, "json"), coupon_list.length <= 0 ? (coupon_text.text("不使用优惠券"), coupon_price.text("")) : (coupon_text.text("优惠金额"), coupon_price.text("¥" + parseInt(coupon_list.attr("data-money")) + ".00")), !1
		}
	}), e(".j-search-input").click(function() {
		e(".j-input-text").val(""), e("input[name=type_select]").val(2), e("body").addClass("show-search-div")
	}), e(".j-close-search").click(function() {
		e("body").removeClass("show-search-div")
	}), e(".j-filter-city").click(function() {
		t = e(window).scrollTop(), e("body").addClass("show-city-div")
	}), e(".j-filter-depot").click(function() {
		t = e(window).scrollTop(), e("body").addClass("show-depot-div")
	}), e(".j-s-filter").click(function() {
		t = e(window).scrollTop(), e("body").addClass("show-filter-div")
		...
		document.addEventListener("touchmove", handler, !1), e(this).find(".filter-site-div").addClass("show")
	}), e(".j-f-c-s-coupon").click(function() {
		e("body").addClass("show-coupon-div")
	}), e(".j-f-c-s-coupon-1").click(function() {
		document.addEventListener("touchmove", handler, !1), e("body").addClass("show-coupon-div-1")
	}), e(".j-f-c-receipt").click(function() {
		document.addEventListener("touchmove", handler, !1), e("body").addClass("show-receipt-div")
	}), e(".j-show-div").click(function() {
		document.addEventListener("touchmove", handler, !1), e(this).find(".j-filter-show-div").addClass("show"), e(".mask-filter-div").addClass("show")
	...
	}), e(".mask-filter-div,.show-div-guanbi").click(function(event) {
		e(".j-filter-show-div").hasClass("show") && e(".j-filter-show-div").removeClass("show"), e(".j-filter-show-list").hasClass("show") && e(".j-filter-show-list").removeClass("show"), e(".shopping-menu").hasClass("nav-active") && e(".shopping-menu").removeClass("nav-active"), e(".shopping-menu").hasClass("position-active") && e(".shopping-menu").removeClass("position-active"), e(".mask-filter-div").removeClass("show"), document.removeEventListener("touchmove", handler, !1);
		var t = "";
		s_get_label = e(".show-goods-attr .s-g-attr-con").find("label.active"), s_get_label.length > 0 && s_get_label.each(function() {
			t += e(this).text() + "、"
		});
		var i = e("#goods_number").val();
		i = parseInt(i) ? parseInt(i) : 1, t = t + i + "个", e(".j-goods-attr").find(".t-goods1").text(t), event.stopPropagation()
	}), e(".j-show-list").click(function() {
		document.addEventListener("touchmove", handler, !1), e(".j-filter-show-list").addClass("show"), e(".mask-filter-div").addClass("show")
	...
	}), e(".div-num-disabled").find("input").attr("readonly", !0), e(".j-flow-checkout-pro span.t-jiantou").click(function() {
		...
		return text_select = e(this).text(), e(this).parents(".text-all-select").find(".j-input-text").val(text_select), e(this).parents(".text-all-select").find(".text-all-select-div").hide(), !1
	}), e(".filter-menu-title").click(function() {
		e(".filter-menu").toggleClass("active")
	}), e(".t-jiantou-gift").click(function() {
		e(".gift-list-box").toggleClass("active"), e(".t-jiantou-gift i").toggleClass("active")
		...
		e(".mask-filter-div").hasClass("show") && e(".mask-filter-div").removeClass("show"), e(".shopping-menu").hasClass("distance-active") ? (e(".shopping-menu").removeClass("distance-active"), e("mask-filter-div").removeClass("show")) : (e(this).addClass("active").siblings().removeClass("active"), e(".shopping-menu").addClass("distance-active"), e(".shopping-menu").removeClass("position-active nav-active"), e("mask-filter-div").addClass("show"))
	}), e(".shopping-nav-con a").click(function() {
		e(this).addClass("active").siblings().removeClass("active"), e(".shopping-menu").removeClass("nav-active"), e(".j-s-nav-select").find("span").text(e(this).text())
	}), e(".j-shopping-pro-list").hasClass("j-shopping-pro-list") && e(window).scroll(function() {
		shopping_menu_h = e(".j-shopping-menu").outerHeight(), shopping_menu_t = e(".j-shopping-pro-list").offset().top - e(document).scrollTop(), shopping_menu_t <= shopping_menu_h ? e(".j-shopping-list").addClass("active") : e(".j-shopping-list").removeClass("active")
		...
		count_span = e(this).siblings("span"), max_length = e(this).attr("maxlength"), textarea_length = e(this).val().length, max_length - textarea_length < 0 ? count_span.text(0) : count_span.text(max_length - textarea_length)
		...
		var t = 0,
			i = 0;
		i = e(window).scrollTop(), win_height = 2 * e(window).height(), i >= win_height ? e(".filter-top").stop().fadeIn(200) : e(".filter-top").stop().fadeOut(200), setTimeout(function() {
			t = i
		}, 0)
	}), e("#loading").hide(), e(".my-com-nav1").click(function() {
		e(".my-com-nav1").siblings(".ect-select").find("label").removeClass("active"), e(this).siblings(".ect-select").find("label").addClass("active")
	}), e(function() {
	...
	e(".my-com-nav2").click(function() {
		...
		j_open_two_select_all = e(".j-open-two-select-all").find(".ect-select label"), j_open_two_select = e(".j-open-two-select").find(".ect-select label"), j_open_two_select_all.hasClass("active") ? (j_open_two_select_all.removeClass("active"), j_open_two_select.removeClass("active")) : (j_open_two_select_all.addClass("active"), j_open_two_select.addClass("active"))
	})
}), $(function(e) {
	e(".user-shop-fx").click(function() {
		...
		return e(".goods-scoll-bg").addClass("active"), e(".goods-nav").hasClass("active") ? (e(".goods-nav").removeClass("active"), e(".goods-scoll-bg").removeClass("active"), !1) : (e(".goods-nav").addClass("active"), e(".goods-scoll-bg").addClass("active"), !1)
	}), e(".goods-scoll-bg").click(function() {
		e(".goods-scoll-bg").removeClass("active"), e(".goods-nav").removeClass("active")
	}), e(window).scroll(function() {
		e(window).scrollTop() > 0 && (e(".goods-scoll-bg").removeClass("active"), e(".goods-nav").removeClass("active"))
	}), e(".j-goods-box").click(function() {
		document.addEventListener("touchmove", handler, !1), e(".goods-banner").addClass("active"), e(".goods-bg-box").addClass("active")
	}), e(".goods-bg-box").click(function() {
		document.removeEventListener("touchmove", handler, !1), e(".goods-banner").removeClass("active"), e(".goods-bg-box").removeClass("active")
	}), e(".j-search-address").click(function() {
		e(".ec-fresh-bg").addClass("active"), e(".t-search-footer").addClass("active")
	}), e(".ec-fresh-bg").click(function() {
		e(".ec-fresh-bg").removeClass("active"), e(".t-search-footer").removeClass("active")
	}), e(".n-goods-shop-list-nav li").on("click", function(t) {
		var i = e(this).attr("category"),
			n = e(".n-goods-shop-list-nav li").index(this);
		e(this).siblings().removeClass("active"), e(".shopping-abs .swiper-slide a").removeClass("active"), e(".div" + i).addClass("active"), swiper_nav.slideTo(n, 1e3, !1), infinite.onload("where=" + i + "&type=1");
		new Swiper(".j-g-s-p-con", {
			scrollbarHide: !0,
			slidesPerView: "auto",
			centeredSlides: !1,
...
region.isAdmin = !1, region.loadRegions = function(e, t, i, n) {
	...
	return $("#province_id").val(e), $.get(region.getFileName(), {
		parent: e,
		type: t,
		user_id: i
	}, function(e) {
	...
	if(0 == e.isRegion)
		if(confirm(e.message)) {
			...
			t.value = e.district, location.href = "index.php?r=user/index/address_list"
	...
	var s = document.getElementById("province_id").value;
	if(t <= 0) return !1;
	n = 1 == n ? n : "", $("#province_id").val(s), $("#city_id").val(t), $("#district_id").val(e), $(".show-city-div").removeClass("show-city-div");
	...
	$.post("index.php?r=user/index/show_region_name", {
		...
		e.district.region_name = e.district.region_name ? e.district.region_name : "", $(".show-region").text(e.province.region_name + e.city.region_name + e.district.region_name)
	}, "json")
...
var funParabola = function(e, t, i) {
	...
	if(e && t && 1 == e.nodeType && 1 == t.nodeType) {
		...
		o.mark = function() {
			...
			return "margin" == r ? e.style.marginLeft = e.style.marginTop = "0px" : e.style[r] = "translate(0, 0)", u = e.getBoundingClientRect(), p = t.getBoundingClientRect(), f = {
			...
			var t = 0,
				...
				n = function() {
					var a = 2 * c * t + d;
					t += i * Math.sqrt(s.speed / (a * a + 1)), (1 == i && t > v.x || i == -1 && t < v.x) && (t = v.x);
					var o = t,
						l = c * o * o + d * o;
			...
			return window.requestAnimationFrame(n), h = !1, this
		}, o.init = function() {
